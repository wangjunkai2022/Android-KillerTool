.class final Lio/reactivex/internal/operators/flowable/lc$b;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lio/reactivex/internal/operators/flowable/lc$b;->aa:Ljava/lang/Object;

    return-void
.end method

.method constructor <init>(Lf/d/c;Lf/d/b;I)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/lc$b;->ea:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/lc$b;->ga:Ljava/util/concurrent/atomic/AtomicLong;

    .line 4
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/lc$b;->ba:Lf/d/b;

    .line 5
    iput p3, p0, Lio/reactivex/internal/operators/flowable/lc$b;->ca:I

    .line 6
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/lc$b;->ga:Ljava/util/concurrent/atomic/AtomicLong;
...
.method d()V
    ...
    .line 3
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/lc$b;->fa:Lio/reactivex/j/g;
    ...
    .line 6
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/lc$b;->ea:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 11
    :cond_4
    sget-object v5, Lio/reactivex/internal/operators/flowable/lc$b;->aa:Ljava/lang/Object;
    ...
    .line 13
    iget-object v5, p0, Lio/reactivex/internal/operators/flowable/lc$b;->ga:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    .line 16
    :cond_6
    iget v2, p0, Lio/reactivex/internal/operators/flowable/lc$b;->ca:I
    ...
    .line 18
    iget-object v7, p0, Lio/reactivex/internal/operators/flowable/lc$b;->ga:Ljava/util/concurrent/atomic/AtomicLong;
    ...
    .line 21
    :cond_7
    iput-object v2, p0, Lio/reactivex/internal/operators/flowable/lc$b;->fa:Lio/reactivex/j/g;
...
.method e()V
    ...
    sget-object v1, Lio/reactivex/internal/operators/flowable/lc$b;->aa:Ljava/lang/Object;
    ...
    .line 3
    invoke-virtual {p0}, Lio/reactivex/internal/operators/flowable/lc$b;->d()V
...
.method public onComplete()V
    ...
    .line 5
    :cond_1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/lc$b;->ga:Ljava/util/concurrent/atomic/AtomicLong;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    .line 2
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/lc$b;->fa:Lio/reactivex/j/g;
...
.method public onSubscribe(Lf/d/d;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/lc$b;->da:Lf/d/d;
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/lc$b;->da:Lf/d/d;
    ...
    .line 6
    :cond_0
    iget v1, p0, Lio/reactivex/internal/operators/flowable/lc$b;->ca:I
    ...
    .line 10
    :cond_1
    iput-object v1, p0, Lio/reactivex/internal/operators/flowable/lc$b;->fa:Lio/reactivex/j/g;

    .line 11
    new-instance v0, Lio/reactivex/internal/operators/flowable/lc$a;

    invoke-direct {v0, p0}, Lio/reactivex/internal/operators/flowable/lc$a;-><init>(Lio/reactivex/internal/operators/flowable/lc$b;)V

    .line 12
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/lc$b;->ea:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    .line 13
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/lc$b;->ga:Ljava/util/concurrent/atomic/AtomicLong;

    invoke-virtual {v1}, Ljava/util/concurrent/atomic/AtomicLong;->getAndIncrement()J

    .line 14
    invoke-interface {p1, v4, v5}, Lf/d/d;->request(J)V

    .line 15
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/lc$b;->ba:Lf/d/b;
