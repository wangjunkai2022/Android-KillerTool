.class public final Lio/reactivex/internal/operators/observable/kb;
...
.method public constructor <init>(Lio/reactivex/A;Lio/reactivex/d/o;)V
    ...
    .line 2
    iput-object p2, p0, Lio/reactivex/internal/operators/observable/kb;->b:Lio/reactivex/d/o;
...
.method protected e(Lio/reactivex/C;)V
    ...
    .line 2
    :try_start_0
    iget-object v1, p0, Lio/reactivex/internal/operators/observable/kb;->b:Lio/reactivex/d/o;
    ...
    .line 3
    new-instance v2, Lio/reactivex/internal/operators/observable/kb$a;

    iget-object v3, p0, Lio/reactivex/internal/operators/observable/a;->a:Lio/reactivex/A;

    invoke-direct {v2, p1, v0, v3}, Lio/reactivex/internal/operators/observable/kb$a;-><init>(Lio/reactivex/C;Lio/reactivex/l/i;Lio/reactivex/A;)V

    .line 4
    invoke-interface {p1, v2}, Lio/reactivex/C;->onSubscribe(Lio/reactivex/b/c;)V

    .line 5
    iget-object p1, v2, Lio/reactivex/internal/operators/observable/kb$a;->e:Lio/reactivex/internal/operators/observable/kb$a$a;

    invoke-interface {v1, p1}, Lio/reactivex/A;->a(Lio/reactivex/C;)V

    .line 6
    invoke-virtual {v2}, Lio/reactivex/internal/operators/observable/kb$a;->c()V
