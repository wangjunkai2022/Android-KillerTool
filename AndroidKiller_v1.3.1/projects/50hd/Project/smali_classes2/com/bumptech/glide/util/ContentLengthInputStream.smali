...
.method private checkReadSoFarOrThrow(I)I
    ...
    const-string/jumbo v1, "Failed to read all expected data, expected: "
    ...
    const-string/jumbo v1, ", but read: "
...
.method private static parseContentLength(Ljava/lang/String;)I
    ...
    const-string/jumbo v3, "failed to parse content length header: "
