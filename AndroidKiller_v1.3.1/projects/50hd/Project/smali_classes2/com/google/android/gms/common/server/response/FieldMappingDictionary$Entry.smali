...
.field final zzamY:Ljava/util/ArrayList;
...
.method constructor <init>(ILjava/lang/String;Ljava/util/ArrayList;)V
    ...
    iput-object p3, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary$Entry;->zzamY:Ljava/util/ArrayList;
...
.method constructor <init>(Ljava/lang/String;Ljava/util/Map;)V
    ...
    invoke-static {p2}, Lcom/google/android/gms/common/server/response/FieldMappingDictionary$Entry;->zzM(Ljava/util/Map;)Ljava/util/ArrayList;

    move-result-object p1

    iput-object p1, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary$Entry;->zzamY:Ljava/util/ArrayList;

    return-void
.end method

.method private static zzM(Ljava/util/Map;)Ljava/util/ArrayList;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {v3, v2, v4}, Lcom/google/android/gms/common/server/response/FieldMappingDictionary$FieldMapPair;-><init>(Ljava/lang/String;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;)V
...
.method zzrC()Ljava/util/HashMap;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary$Entry;->zzamY:Ljava/util/ArrayList;
    ...
    iget-object v3, p0, Lcom/google/android/gms/common/server/response/FieldMappingDictionary$Entry;->zzamY:Ljava/util/ArrayList;
    ...
    iget-object v3, v3, Lcom/google/android/gms/common/server/response/FieldMappingDictionary$FieldMapPair;->zzamZ:Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;
