...
.field private final zzamG:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
            "Ljava/lang/String;",
...
.field private final zzamH:Ljava/util/HashMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Ljava/util/HashMap<",
            "Ljava/lang/Integer;",
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->zzamG:Ljava/util/HashMap;

    new-instance v0, Ljava/util/HashMap;

    invoke-direct {v0}, Ljava/util/HashMap;-><init>()V

    iput-object v0, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->zzamH:Ljava/util/HashMap;

    const/4 v0, 0x0

    iput-object v0, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->zzamI:Ljava/util/ArrayList;
...
.method constructor <init>(ILjava/util/ArrayList;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->zzamG:Ljava/util/HashMap;

    new-instance p1, Ljava/util/HashMap;

    invoke-direct {p1}, Ljava/util/HashMap;-><init>()V

    iput-object p1, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->zzamH:Ljava/util/HashMap;

    const/4 p1, 0x0

    iput-object p1, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->zzamI:Ljava/util/ArrayList;
...
.method private zzd(Ljava/util/ArrayList;)V
    ...
    iget-object v1, v0, Lcom/google/android/gms/common/server/converter/StringToIntConverter$Entry;->zzamJ:Ljava/lang/String;

    iget v0, v0, Lcom/google/android/gms/common/server/converter/StringToIntConverter$Entry;->zzamK:I
...
.method public zzb(Ljava/lang/Integer;)Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->zzamH:Ljava/util/HashMap;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->zzamG:Ljava/util/HashMap;

    const-string/jumbo v1, "gms_unknown"
...
.method zzri()Ljava/util/ArrayList;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->zzamG:Ljava/util/HashMap;
    ...
    iget-object v4, p0, Lcom/google/android/gms/common/server/converter/StringToIntConverter;->zzamG:Ljava/util/HashMap;
