...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagl:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;Lcom/google/android/gms/common/api/GoogleApiClient$ConnectionCallbacks;Lcom/google/android/gms/common/api/GoogleApiClient$OnConnectionFailedListener;)V
    ...
    const-string/jumbo p1, "Must provide a connected listener"
    ...
    iget-object p1, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagu:Ljava/util/ArrayList;

    invoke-virtual {p1, p2}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    const-string/jumbo p1, "Must provide a connection failed listener"
    ...
    iget-object p1, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagv:Ljava/util/ArrayList;
...
.method static synthetic zza(Lcom/google/android/gms/common/api/GoogleApiClient$Builder;)Landroid/support/v4/app/FragmentActivity;
    ...
    iget-object p0, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzago:Landroid/support/v4/app/FragmentActivity;
...
.method private varargs zza(Lcom/google/android/gms/common/api/Api;Lcom/google/android/gms/common/api/Api$ApiOptions;I[Lcom/google/android/gms/common/api/Scope;)V
    ...
    invoke-virtual {v2, p2}, Lcom/google/android/gms/common/api/Api$zza;->zzo(Ljava/lang/Object;)Ljava/util/List;
    ...
    :cond_1
    iget-object p2, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagm:Ljava/util/Map;
    ...
    const-string/jumbo p4, "Invalid resolution mode: \'"

    invoke-virtual {p2, p4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {p2, p3}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string/jumbo p3, "\', use a constant from GoogleApiClient.ResolutionMode"
...
.method private zzoZ()Lcom/google/android/gms/common/api/GoogleApiClient;
    ...
    invoke-virtual/range {p0 .. p0}, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzoY()Lcom/google/android/gms/common/internal/zzf;

    move-result-object v8

    invoke-virtual {v8}, Lcom/google/android/gms/common/internal/zzf;->zzqu()Ljava/util/Map;
    ...
    iget-object v1, v0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagn:Ljava/util/Map;
    ...
    const-string/jumbo v15, " cannot be used with "
    ...
    iget-object v2, v0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagn:Ljava/util/Map;
    ...
    iget-boolean v3, v3, Lcom/google/android/gms/common/internal/zzf$zza;->zzalf:Z
    ...
    invoke-direct {v6, v7, v3}, Lcom/google/android/gms/common/api/internal/zzc;-><init>(Lcom/google/android/gms/common/api/Api;I)V

    invoke-virtual {v14, v6}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    invoke-virtual {v7}, Lcom/google/android/gms/common/api/Api;->zzoS()Z

    move-result v3

    if-eqz v3, :cond_3

    invoke-virtual {v7}, Lcom/google/android/gms/common/api/Api;->zzoQ()Lcom/google/android/gms/common/api/Api$zze;
    ...
    iget-object v5, v0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagr:Landroid/os/Looper;
    ...
    invoke-virtual/range {v18 .. v18}, Lcom/google/android/gms/common/api/Api;->zzoP()Lcom/google/android/gms/common/api/Api$zza;
    ...
    :goto_4
    invoke-virtual/range {v18 .. v18}, Lcom/google/android/gms/common/api/Api;->zzoR()Lcom/google/android/gms/common/api/Api$zzc;
    ...
    iget-object v1, v0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzTI:Landroid/accounts/Account;
    ...
    const-string/jumbo v5, "Must not set an account in GoogleApiClient.Builder when using %s. Set account in GoogleSignInOptions.Builder instead"

    invoke-static {v1, v5, v2}, Lcom/google/android/gms/common/internal/zzx;->zza(ZLjava/lang/String;[Ljava/lang/Object;)V

    iget-object v1, v0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagh:Ljava/util/Set;

    iget-object v2, v0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagi:Ljava/util/Set;
    ...
    const-string/jumbo v3, "Must not set scopes in GoogleApiClient.Builder when using %s. Set account in GoogleSignInOptions.Builder instead."
    ...
    invoke-static {v1, v4}, Lcom/google/android/gms/common/api/internal/zzj;->zza(Ljava/lang/Iterable;Z)I

    move-result v13

    new-instance v15, Lcom/google/android/gms/common/api/internal/zzj;
    ...
    iget-object v4, v0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagr:Landroid/os/Looper;

    iget-object v6, v0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzags:Lcom/google/android/gms/common/zzc;

    iget-object v7, v0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagt:Lcom/google/android/gms/common/api/Api$zza;

    iget-object v9, v0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagu:Ljava/util/ArrayList;

    iget-object v12, v0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagv:Ljava/util/ArrayList;

    iget v5, v0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagp:I
...
.method public addApi(Lcom/google/android/gms/common/api/Api;)Lcom/google/android/gms/common/api/GoogleApiClient$Builder;
    ...
    invoke-virtual {p1, v1}, Lcom/google/android/gms/common/api/Api$zza;->zzo(Ljava/lang/Object;)Ljava/util/List;

    move-result-object p1

    iget-object v0, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagi:Ljava/util/Set;
...
.method public addApi(Lcom/google/android/gms/common/api/Api;Lcom/google/android/gms/common/api/Api$ApiOptions$HasOptions;)Lcom/google/android/gms/common/api/GoogleApiClient$Builder;
    ...
    invoke-virtual {p1, p2}, Lcom/google/android/gms/common/api/Api$zza;->zzo(Ljava/lang/Object;)Ljava/util/List;

    move-result-object p1

    iget-object p2, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagi:Ljava/util/Set;

    invoke-interface {p2, p1}, Ljava/util/Set;->addAll(Ljava/util/Collection;)Z

    iget-object p2, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagh:Ljava/util/Set;
...
.method public enableAutoManage(Landroid/support/v4/app/FragmentActivity;ILcom/google/android/gms/common/api/GoogleApiClient$OnConnectionFailedListener;)Lcom/google/android/gms/common/api/GoogleApiClient$Builder;
    ...
    const-string/jumbo p2, "Null activity is not permitted."
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzago:Landroid/support/v4/app/FragmentActivity;
...
.method public setAccountName(Ljava/lang/String;)Lcom/google/android/gms/common/api/GoogleApiClient$Builder;
    ...
    :goto_0
    iput-object p1, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzTI:Landroid/accounts/Account;
...
.method public setHandler(Landroid/os/Handler;)Lcom/google/android/gms/common/api/GoogleApiClient$Builder;
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagr:Landroid/os/Looper;
...
.method public zzoY()Lcom/google/android/gms/common/internal/zzf;
    ...
    sget-object v0, Lcom/google/android/gms/internal/zzro;->zzbgV:Lcom/google/android/gms/internal/zzro;

    iget-object v1, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagn:Ljava/util/Map;

    sget-object v2, Lcom/google/android/gms/internal/zzrl;->API:Lcom/google/android/gms/common/api/Api;
    ...
    iget-object v2, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzTI:Landroid/accounts/Account;

    iget-object v3, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagh:Ljava/util/Set;

    iget-object v4, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagm:Ljava/util/Map;

    iget v5, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagj:I

    iget-object v6, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagk:Landroid/view/View;

    iget-object v7, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzUW:Ljava/lang/String;

    iget-object v8, p0, Lcom/google/android/gms/common/api/GoogleApiClient$Builder;->zzagl:Ljava/lang/String;

    move-object v1, v0

    invoke-direct/range {v1 .. v9}, Lcom/google/android/gms/common/internal/zzf;-><init>(Landroid/accounts/Account;Ljava/util/Set;Ljava/util/Map;ILandroid/view/View;Ljava/lang/String;Ljava/lang/String;Lcom/google/android/gms/internal/zzro;)V
