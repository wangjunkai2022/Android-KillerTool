...
.field private final zzamT:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

.field private final zzana:Landroid/os/Parcel;
...
.method constructor <init>(ILandroid/os/Parcel;Lcom/google/android/gms/common/server/response/FieldMappingDictionary;)V
    ...
    iput-object p2, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzana:Landroid/os/Parcel;

    const/4 p1, 0x2

    iput p1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzanb:I

    iput-object p3, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzamT:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

    iget-object p2, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzamT:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;
    ...
    :cond_0
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->zzrB()Ljava/lang/String;
    ...
    iput p1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzanc:I
...
.method private constructor <init>(Lcom/google/android/gms/common/internal/safeparcel/SafeParcelable;Lcom/google/android/gms/common/server/response/FieldMappingDictionary;Ljava/lang/String;)V
    ...
    iput-object v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzana:Landroid/os/Parcel;

    iget-object v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzana:Landroid/os/Parcel;

    const/4 v2, 0x0

    invoke-interface {p1, v1, v2}, Landroid/os/Parcelable;->writeToParcel(Landroid/os/Parcel;I)V

    iput v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzanb:I

    invoke-static {p2}, Lcom/google/android/gms/common/internal/zzx;->zzz(Ljava/lang/Object;)Ljava/lang/Object;

    check-cast p2, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

    iput-object p2, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzamT:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;
...
.method private static zzN(Ljava/util/Map;)Ljava/util/HashMap;
    .locals 3
    ...
    invoke-virtual {v2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzrs()I
...
.method private static zza(Lcom/google/android/gms/common/server/response/FieldMappingDictionary;Lcom/google/android/gms/common/server/response/FastJsonResponse;)V
    ...
    invoke-virtual {p1}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zzrl()Ljava/util/Map;
    ...
    invoke-virtual {v1}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzrt()Ljava/lang/Class;
    ...
    const-string/jumbo v2, "Could not access object of type "
    ...
    const-string/jumbo v2, "Could not instantiate an object of type "
...
.method private zza(Ljava/lang/StringBuilder;ILjava/lang/Object;)V
    ...
    const-string/jumbo p2, "Method does not accept concrete type."
    ...
    invoke-static {p1, p3}, Lcom/google/android/gms/internal/zznc;->zza(Ljava/lang/StringBuilder;Ljava/util/HashMap;)V
    ...
    invoke-static {p3}, Lcom/google/android/gms/internal/zzmo;->zzk([B)Ljava/lang/String;
    ...
    invoke-static {p3}, Lcom/google/android/gms/internal/zzmo;->zzj([B)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/google/android/gms/internal/zznb;->zzcU(Ljava/lang/String;)Ljava/lang/String;
...
.method private zza(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Landroid/os/Parcel;I)V
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzrk()I
    ...
    const-string/jumbo p4, "Unknown field out type = "
    ...
    :goto_0
    invoke-virtual {p0, p2, p3}, Lcom/google/android/gms/common/server/response/FastJsonResponse;->zza(Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private zza(Ljava/lang/StringBuilder;Ljava/lang/String;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Landroid/os/Parcel;I)V
    ...
    invoke-virtual {p3}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzrv()Z
...
.method private zza(Ljava/lang/StringBuilder;Ljava/util/Map;Landroid/os/Parcel;)V
    ...
    invoke-static {p2}, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzN(Ljava/util/Map;)Ljava/util/HashMap;
...
.method private static zzb(Lcom/google/android/gms/common/server/response/FastJsonResponse;)Lcom/google/android/gms/common/server/response/FieldMappingDictionary;
    ...
    invoke-virtual {v0}, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->zzrz()V

    invoke-virtual {v0}, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->zzry()V
...
.method private zzb(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Landroid/os/Parcel;I)V
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzrq()Z
    ...
    const-string/jumbo p2, "Unknown field type out."
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzrx()Ljava/util/Map;
    ...
    const-string/jumbo p2, "List of type BASE64, BASE64_URL_SAFE, or STRING_MAP is not supported"
    ...
    invoke-static {p1, p2}, Lcom/google/android/gms/internal/zzmn;->zza(Ljava/lang/StringBuilder;[Ljava/lang/String;)V
    ...
    invoke-static {p1, p2}, Lcom/google/android/gms/internal/zzmn;->zza(Ljava/lang/StringBuilder;[Z)V
    ...
    invoke-static {p1, p2}, Lcom/google/android/gms/internal/zzmn;->zza(Ljava/lang/StringBuilder;[Ljava/lang/Object;)V
    ...
    invoke-static {p1, p2}, Lcom/google/android/gms/internal/zzmn;->zza(Ljava/lang/StringBuilder;[D)V
    ...
    invoke-static {p1, p2}, Lcom/google/android/gms/internal/zzmn;->zza(Ljava/lang/StringBuilder;[F)V
    ...
    invoke-static {p1, p2}, Lcom/google/android/gms/internal/zzmn;->zza(Ljava/lang/StringBuilder;[J)V
    ...
    invoke-static {p1, p2}, Lcom/google/android/gms/internal/zzmn;->zza(Ljava/lang/StringBuilder;[I)V
    ...
    invoke-static {p4}, Lcom/google/android/gms/internal/zznb;->zzcU(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/google/android/gms/internal/zzmo;->zzk([B)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/google/android/gms/internal/zzmo;->zzj([B)Ljava/lang/String;
...
.method private zzb(Ljava/lang/StringBuilder;Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;Ljava/lang/Object;)V
    ...
    invoke-virtual {p2}, Lcom/google/android/gms/common/server/response/FastJsonResponse$Field;->zzrp()Z
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzamT:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;
    ...
    invoke-virtual {p0}, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzrD()Landroid/os/Parcel;
    ...
    iget-object v2, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzamT:Lcom/google/android/gms/common/server/response/FieldMappingDictionary;

    iget-object v3, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->mClassName:Ljava/lang/String;

    invoke-virtual {v2, v3}, Lcom/google/android/gms/common/server/response/FieldMappingDictionary;->zzcR(Ljava/lang/String;)Ljava/util/Map;
...
.method protected zzcN(Ljava/lang/String;)Ljava/lang/Object;
    .locals 1

    new-instance p1, Ljava/lang/UnsupportedOperationException;

    const-string/jumbo v0, "Converting to JSON does not require this method."
...
.method protected zzcO(Ljava/lang/String;)Z
    .locals 1
...
.method public zzrD()Landroid/os/Parcel;
    .locals 3

    iget v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzanc:I
    ...
    :cond_0
    iget-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzana:Landroid/os/Parcel;

    invoke-static {v0}, Lcom/google/android/gms/common/internal/safeparcel/zzb;->zzav(Landroid/os/Parcel;)I

    move-result v0

    iput v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzand:I

    :cond_1
    iget-object v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzana:Landroid/os/Parcel;

    iget v2, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzand:I

    invoke-static {v0, v2}, Lcom/google/android/gms/common/internal/safeparcel/zzb;->zzI(Landroid/os/Parcel;I)V

    iput v1, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzanc:I
...
.method zzrE()Lcom/google/android/gms/common/server/response/FieldMappingDictionary;
    .locals 3

    iget v0, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzanb:I
    ...
    iget v2, p0, Lcom/google/android/gms/common/server/response/SafeParcelResponse;->zzanb:I
...
.method public zzrl()Ljava/util/Map;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
