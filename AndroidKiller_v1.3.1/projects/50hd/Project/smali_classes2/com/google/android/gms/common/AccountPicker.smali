...
.method public static zza(Landroid/accounts/Account;Ljava/util/ArrayList;[Ljava/lang/String;ZLjava/lang/String;Ljava/lang/String;[Ljava/lang/String;Landroid/os/Bundle;ZIILjava/lang/String;Z)Landroid/content/Intent;
    ...
    const-string/jumbo p12, "com.google.android.gms.common.account.CHOOSE_ACCOUNT_USERTILE"

    goto :goto_1

    :cond_2
    const-string/jumbo p12, "com.google.android.gms.common.account.CHOOSE_ACCOUNT"

    :goto_1
    invoke-virtual {v0, p12}, Landroid/content/Intent;->setAction(Ljava/lang/String;)Landroid/content/Intent;

    const-string/jumbo p12, "com.google.android.gms"

    invoke-virtual {v0, p12}, Landroid/content/Intent;->setPackage(Ljava/lang/String;)Landroid/content/Intent;

    const-string/jumbo p12, "allowableAccounts"

    invoke-virtual {v0, p12, p1}, Landroid/content/Intent;->putExtra(Ljava/lang/String;Ljava/io/Serializable;)Landroid/content/Intent;
    ...
    const-string/jumbo p0, "hostedDomainFilter"
