...
.method public static castParam(Ljava/lang/Object;Ljava/lang/String;ILjava/lang/String;ILjava/lang/Class;)Ljava/lang/Object;
    ...
    const-string/jumbo p2, " of method \'"

    invoke-virtual {v0, p2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, p1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string/jumbo p1, "\' was of the wrong type for parameter #"
    ...
    const-string/jumbo p1, "\'. See cause for more info."
...
.method public static castView(Landroid/view/View;ILjava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;
    ...
    const-string/jumbo p0, "\' with ID "

    invoke-virtual {v1, p0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, p1}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string/jumbo p0, " for "

    invoke-virtual {v1, p0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, p2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string/jumbo p0, " was of the wrong type. See cause for more info."
...
.method public static findRequiredView(Landroid/view/View;ILjava/lang/String;)Landroid/view/View;
    ...
    const-string/jumbo v2, "Required view \'"
    ...
    const-string/jumbo p0, " was not found. If this view is optional add \'@Nullable\' (fields) or \'@Optional\' (methods) annotation."
...
.method public static getFloat(Landroid/content/Context;I)F
    ...
    const-string/jumbo p1, " is not valid"
...
.method private static getResourceEntryName(Landroid/view/View;I)Ljava/lang/String;
    ...
    const-string/jumbo p0, "<unavailable while editing>"
...
.method public static getTintedDrawable(Landroid/content/Context;II)Landroid/graphics/drawable/Drawable;
    ...
    const-string/jumbo v1, "Required tint color attribute with name "
    ...
    const-string/jumbo p0, " and attribute ID "

    invoke-virtual {v0, p0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v0, p2}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string/jumbo p0, " was not found."
