...
.method private static clearOldDexDir(Landroid/content/Context;)V
    ...
    const-string/jumbo v1, "Clearing old secondary dex dir ("
    ...
    const-string/jumbo v1, "Failed to delete secondary dex dir "
    ...
    const-string/jumbo v1, "Deleted old secondary dex dir "
...
.method private static doInstallation(Landroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;)V
    ...
    const-string/jumbo v4, "MultiDex is not guaranteed to work in SDK version "
    ...
    const-string/jumbo v4, ": SDK version higher than "

    invoke-virtual {v3, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v3, v2}, Ljava/lang/StringBuilder;->append(I)Ljava/lang/StringBuilder;

    const-string/jumbo v2, " should be backed by "

    invoke-virtual {v3, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string/jumbo v2, "runtime with built-in multidex capabilty but it\'s not the "

    invoke-virtual {v3, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string/jumbo v2, "case here: java.vm.version=\""
    ...
    :try_start_2
    const-string/jumbo p0, "MultiDex"

    const-string/jumbo p1, "Context class loader is null. Must be running in test mode. Skip patching."
    ...
    const-string/jumbo v4, "Something went wrong when trying to clear old MultiDex extraction, continuing without cleaning."
    ...
    const-string/jumbo p1, "MultiDex"

    const-string/jumbo p2, "Failure while trying to obtain Context class loader. Must be running in test mode. Skip patching."
...
.method private static varargs findMethod(Ljava/lang/Object;Ljava/lang/String;[Ljava/lang/Class;)Ljava/lang/reflect/Method;
    ...
    const-string/jumbo p1, " with parameters "
...
.method private static getApplicationInfo(Landroid/content/Context;)Landroid/content/pm/ApplicationInfo;
    ...
    const-string/jumbo v1, "Failure while trying to obtain ApplicationInfo from Context. Must be running in test mode. Skip patching."
...
.method public static install(Landroid/content/Context;)V
    ...
    const-string/jumbo v1, "Installing application"
    ...
    const-string/jumbo p0, "VM has multidex support, MultiDex support library is disabled."
    ...
    const-string/jumbo p0, "No ApplicationInfo available, i.e. running on a test Context: MultiDex support library is disabled."
    ...
    invoke-static {p0, v2, v3, v1, v4}, Landroid/support/multidex/MultiDex;->doInstallation(Landroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    const-string/jumbo p0, "install done"
    ...
    const-string/jumbo v2, "MultiDex installation failed ("
    ...
    const-string/jumbo v1, "MultiDex installation failed. SDK "
    ...
    const-string/jumbo v1, " is unsupported. Min SDK version is "
...
.method public static installInstrumentation(Landroid/content/Context;Landroid/content/Context;)V
    ...
    const-string/jumbo v2, "Installing instrumentation"

    .line 1
    invoke-static {v1, v2}, Landroid/util/Log;->i(Ljava/lang/String;Ljava/lang/String;)I

    .line 2
    sget-boolean v2, Landroid/support/multidex/MultiDex;->IS_VM_MULTIDEX_CAPABLE:Z
    ...
    const-string/jumbo p0, "No ApplicationInfo available for instrumentation, i.e. running on a test Context: MultiDex support library is disabled."
    ...
    invoke-static {p1, v5, v3, v2, p0}, Landroid/support/multidex/MultiDex;->doInstallation(Landroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-static {p1, p0, v3, v0, v2}, Landroid/support/multidex/MultiDex;->doInstallation(Landroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0

    const-string/jumbo p0, "Installation done"
    ...
    const-string/jumbo p1, "MultiDex installation failure"
    ...
    const-string/jumbo v1, "MultiDex installation failed ("
    ...
    const-string/jumbo v0, "MultiDex installation failed. SDK "
    ...
    const-string/jumbo v0, " is unsupported. Min SDK version is "
...
.method static isVMMultidexCapable(Ljava/lang/String;)Z
    ...
    const-string/jumbo p0, " has multidex support"

    goto :goto_0

    :cond_2
    const-string/jumbo p0, " does not have multidex support"
...
.method private static mkdirChecked(Ljava/io/File;)V
    ...
    const-string/jumbo v1, "Failed to create dir "
    ...
    const-string/jumbo v1, ". Parent file is null."
    ...
    const-string/jumbo v1, ". parent file is a dir "
