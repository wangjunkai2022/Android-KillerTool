...
.method static load(Landroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Z)Ljava/util/List;
    ...
    const-string/jumbo v8, "Failed to release lock on "
    ...
    const-string/jumbo v4, "Blocking on lock "
    ...
    :cond_1
    const-string/jumbo v0, "Detected that extraction must be performed."
...
.method private static loadExistingExtractions(Landroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;)Ljava/util/List;
    ...
    const-string/jumbo v2, "loading existing secondary dex files"
    ...
    const-string/jumbo v4, "dex.number"
    ...
    const-string/jumbo v3, "Invalid extracted dex: "
    ...
    const-string/jumbo v0, "\"), expected modification time: "

    invoke-virtual {v2, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v2, v9, v10}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    const-string/jumbo v0, ", modification time: "

    invoke-virtual {v2, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v2, v13, v14}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    const-string/jumbo v0, ", expected crc: "

    invoke-virtual {v2, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v2, v11, v12}, Ljava/lang/StringBuilder;->append(J)Ljava/lang/StringBuilder;

    const-string/jumbo v0, ", file crc: "
...
.method private static prepareDexDir(Ljava/io/File;Ljava/lang/String;)V
    ...
    const-string/jumbo v4, "Trying to delete old file "
    ...
    const-string/jumbo v4, "Failed to delete old file "
    ...
    const-string/jumbo v4, "Deleted old file "
