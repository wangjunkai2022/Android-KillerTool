...
.method public addToSolver(Landroid/support/constraint/solver/LinearSystem;)V
    ...
    iput-object v1, v6, Landroid/support/constraint/solver/widgets/ConstraintAnchor;->mSolverVariable:Landroid/support/constraint/solver/SolverVariable;
    ...
    .line 9
    :goto_1
    iget v6, p0, Landroid/support/constraint/solver/widgets/Helper;->mWidgetsCount:I

    if-ge v1, v6, :cond_6

    .line 10
    iget-object v6, p0, Landroid/support/constraint/solver/widgets/Helper;->mWidgets:[Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .line 19
    :goto_7
    iget v7, p0, Landroid/support/constraint/solver/widgets/Helper;->mWidgetsCount:I

    if-ge v6, v7, :cond_d

    .line 20
    iget-object v7, p0, Landroid/support/constraint/solver/widgets/Helper;->mWidgets:[Landroid/support/constraint/solver/widgets/ConstraintWidget;
...
.method public analyze(I)V
    ...
    .line 8
    invoke-virtual {p1, v3}, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->setType(I)V
    ...
    invoke-virtual {v3, v5, v4}, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->resolve(Landroid/support/constraint/solver/widgets/ResolutionAnchor;F)V
    ...
    .line 15
    :goto_3
    iget v4, p0, Landroid/support/constraint/solver/widgets/Helper;->mWidgetsCount:I

    if-ge v3, v4, :cond_e

    .line 16
    iget-object v4, p0, Landroid/support/constraint/solver/widgets/Helper;->mWidgets:[Landroid/support/constraint/solver/widgets/ConstraintWidget;
    ...
    .line 24
    invoke-virtual {v4, p1}, Landroid/support/constraint/solver/widgets/ResolutionNode;->addDependent(Landroid/support/constraint/solver/widgets/ResolutionNode;)V
...
.method public resetResolutionNodes()V
    ...
    .line 1
    invoke-super {p0}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->resetResolutionNodes()V
...
.method public resolve()V
    ...
    .line 8
    iget v9, v8, Landroid/support/constraint/solver/widgets/ResolutionNode;->state:I
    ...
    .line 11
    iget-object v1, v8, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->resolvedTarget:Landroid/support/constraint/solver/widgets/ResolutionAnchor;
    ...
    iget-wide v7, v5, Landroid/support/constraint/solver/Metrics;->barrierConnectionResolved:J

    const-wide/16 v9, 0x1

    add-long/2addr v7, v9

    iput-wide v7, v5, Landroid/support/constraint/solver/Metrics;->barrierConnectionResolved:J
    ...
    invoke-virtual {v0, v6, v1}, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->resolve(Landroid/support/constraint/solver/widgets/ResolutionAnchor;F)V
