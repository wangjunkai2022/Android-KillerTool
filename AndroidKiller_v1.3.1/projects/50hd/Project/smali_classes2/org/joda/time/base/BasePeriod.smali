...
# static fields
.field private static final DUMMY_PERIOD:Lorg/joda/time/p;
...
.method static constructor <clinit>()V
    ...
    .line 1
    new-instance v0, Lorg/joda/time/base/h;

    invoke-direct {v0}, Lorg/joda/time/base/h;-><init>()V

    sput-object v0, Lorg/joda/time/base/BasePeriod;->DUMMY_PERIOD:Lorg/joda/time/p;
...
.method protected constructor <init>(J)V
    ...
    sget-object v1, Lorg/joda/time/base/BasePeriod;->DUMMY_PERIOD:Lorg/joda/time/p;

    invoke-virtual {v0, v1, p1, p2}, Lorg/joda/time/chrono/BaseChronology;->get(Lorg/joda/time/p;J)[I
...
.method protected constructor <init>(JJLorg/joda/time/PeriodType;Lorg/joda/time/a;)V
    .locals 6
    ...
    .line 7
    invoke-static {p6}, Lorg/joda/time/d;->a(Lorg/joda/time/a;)Lorg/joda/time/a;
...
.method protected constructor <init>(JLorg/joda/time/PeriodType;Lorg/joda/time/a;)V
    ...
    .line 62
    invoke-static {p4}, Lorg/joda/time/d;->a(Lorg/joda/time/a;)Lorg/joda/time/a;
    ...
    .line 64
    invoke-virtual {p4, p0, p1, p2}, Lorg/joda/time/a;->get(Lorg/joda/time/p;J)[I
...
.method protected constructor <init>(Ljava/lang/Object;Lorg/joda/time/PeriodType;Lorg/joda/time/a;)V
    .locals 2
    ...
    invoke-virtual {v0, p1}, Lorg/joda/time/a/d;->e(Ljava/lang/Object;)Lorg/joda/time/a/m;
    ...
    .line 67
    invoke-interface {v0, p1}, Lorg/joda/time/a/m;->b(Ljava/lang/Object;)Lorg/joda/time/PeriodType;
    ...
    .line 70
    instance-of v1, p0, Lorg/joda/time/j;

    if-eqz v1, :cond_1

    .line 71
    invoke-virtual {p0}, Lorg/joda/time/base/f;->size()I
    ...
    check-cast p3, Lorg/joda/time/j;

    invoke-interface {v0, p3, p1, p2}, Lorg/joda/time/a/m;->a(Lorg/joda/time/j;Ljava/lang/Object;Lorg/joda/time/a;)V
    ...
    invoke-virtual {v0}, Lorg/joda/time/base/f;->getValues()[I
...
.method protected constructor <init>(Lorg/joda/time/l;Lorg/joda/time/m;Lorg/joda/time/PeriodType;)V
    .locals 8
    ...
    .line 51
    invoke-static {v6, v7, v0, v1}, Lorg/joda/time/field/e;->e(JJ)J
...
.method protected constructor <init>(Lorg/joda/time/m;Lorg/joda/time/l;Lorg/joda/time/PeriodType;)V
    .locals 6
...
.method protected constructor <init>(Lorg/joda/time/m;Lorg/joda/time/m;Lorg/joda/time/PeriodType;)V
    .locals 6
    ...
    .line 16
    invoke-static {p1, p2}, Lorg/joda/time/d;->a(Lorg/joda/time/m;Lorg/joda/time/m;)Lorg/joda/time/a;
...
.method protected constructor <init>(Lorg/joda/time/o;Lorg/joda/time/o;Lorg/joda/time/PeriodType;)V
    .locals 7
    ...
    .line 20
    instance-of v0, p1, Lorg/joda/time/base/g;

    if-eqz v0, :cond_0

    instance-of v0, p2, Lorg/joda/time/base/g;
    ...
    check-cast v0, Lorg/joda/time/base/g;

    invoke-virtual {v0}, Lorg/joda/time/base/g;->getLocalMillis()J

    move-result-wide v3

    .line 23
    check-cast p2, Lorg/joda/time/base/g;

    invoke-virtual {p2}, Lorg/joda/time/base/g;->getLocalMillis()J
    ...
    .line 27
    invoke-virtual/range {v1 .. v6}, Lorg/joda/time/a;->get(Lorg/joda/time/p;JJ)[I
    ...
    invoke-interface {p2}, Lorg/joda/time/o;->size()I
    ...
    invoke-interface {p2, v0}, Lorg/joda/time/o;->getFieldType(I)Lorg/joda/time/DateTimeFieldType;
    ...
    .line 35
    invoke-virtual {v0, p1, v1, v2}, Lorg/joda/time/a;->set(Lorg/joda/time/o;J)J

    move-result-wide v3

    invoke-virtual {v0, p2, v1, v2}, Lorg/joda/time/a;->set(Lorg/joda/time/o;J)J
    ...
    const-string/jumbo p2, "ReadablePartial objects must be contiguous"
    ...
    const-string/jumbo p2, "ReadablePartial objects must not be null"
...
.method private checkAndUpdate(Lorg/joda/time/DurationFieldType;[II)V
    ...
    .line 1
    invoke-virtual {p0, p1}, Lorg/joda/time/base/f;->indexOf(Lorg/joda/time/DurationFieldType;)I
    ...
    const-string/jumbo v0, "Period does not support field \'"
...
.method private setPeriodInternal(Lorg/joda/time/p;)V
    .locals 5
...
.method protected addFieldInto([ILorg/joda/time/DurationFieldType;I)V
    ...
    .line 1
    invoke-virtual {p0, p2}, Lorg/joda/time/base/f;->indexOf(Lorg/joda/time/DurationFieldType;)I
    ...
    invoke-static {p2, p3}, Lorg/joda/time/field/e;->a(II)I
...
.method protected addPeriod(Lorg/joda/time/p;)V
    .locals 1

    if-eqz p1, :cond_0

    .line 1
    invoke-virtual {p0}, Lorg/joda/time/base/f;->getValues()[I

    move-result-object v0

    invoke-virtual {p0, v0, p1}, Lorg/joda/time/base/BasePeriod;->addPeriodInto([ILorg/joda/time/p;)[I
...
.method protected addPeriodInto([ILorg/joda/time/p;)[I
    .locals 6

    .line 1
    invoke-interface {p2}, Lorg/joda/time/p;->size()I
    ...
    .line 2
    invoke-interface {p2, v1}, Lorg/joda/time/p;->getFieldType(I)Lorg/joda/time/DurationFieldType;

    move-result-object v2

    .line 3
    invoke-interface {p2, v1}, Lorg/joda/time/p;->getValue(I)I
    ...
    .line 4
    invoke-virtual {p0, v2}, Lorg/joda/time/base/f;->indexOf(Lorg/joda/time/DurationFieldType;)I
    ...
    invoke-static {v2, v3}, Lorg/joda/time/field/e;->a(II)I
...
.method protected checkPeriodType(Lorg/joda/time/PeriodType;)Lorg/joda/time/PeriodType;
    ...
    .line 1
    invoke-static {p1}, Lorg/joda/time/d;->a(Lorg/joda/time/PeriodType;)Lorg/joda/time/PeriodType;
...
.method protected mergePeriod(Lorg/joda/time/p;)V
    .locals 1
    ...
    invoke-virtual {p0, v0, p1}, Lorg/joda/time/base/BasePeriod;->mergePeriodInto([ILorg/joda/time/p;)[I
...
.method protected mergePeriodInto([ILorg/joda/time/p;)[I
    .locals 4
...
.method protected setPeriod(Lorg/joda/time/p;)V
    .locals 0
    ...
    .line 2
    :cond_0
    invoke-direct {p0, p1}, Lorg/joda/time/base/BasePeriod;->setPeriodInternal(Lorg/joda/time/p;)V
...
.method public toDurationFrom(Lorg/joda/time/m;)Lorg/joda/time/Duration;
    .locals 4
    ...
    .line 3
    invoke-virtual {p1, p0, v0, v1, v2}, Lorg/joda/time/a;->add(Lorg/joda/time/p;JI)J
...
.method public toDurationTo(Lorg/joda/time/m;)Lorg/joda/time/Duration;
    .locals 4
