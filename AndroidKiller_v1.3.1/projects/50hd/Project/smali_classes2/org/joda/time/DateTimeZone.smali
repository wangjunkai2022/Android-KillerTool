...
.method static constructor <clinit>()V
    ...
    .line 1
    sget-object v0, Lorg/joda/time/q;->a:Lorg/joda/time/DateTimeZone;
...
.method public static forID(Ljava/lang/String;)Lorg/joda/time/DateTimeZone;
    ...
    .line 4
    :cond_1
    invoke-static {}, Lorg/joda/time/DateTimeZone;->getProvider()Lorg/joda/time/tz/d;

    move-result-object v0

    invoke-interface {v0, p0}, Lorg/joda/time/tz/d;->a(Ljava/lang/String;)Lorg/joda/time/DateTimeZone;
    ...
    const-string/jumbo v2, "The datetime zone id \'"

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v1, p0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string/jumbo p0, "\' is not recognised"
...
.method public static forOffsetHoursMinutes(II)Lorg/joda/time/DateTimeZone;
    ...
    const-string/jumbo v1, "Positive hours must not have negative minutes: "
    ...
    .line 4
    invoke-static {p0, p1}, Lorg/joda/time/field/e;->b(II)I
    ...
    const-string/jumbo p1, "Offset is too large"
    ...
    const-string/jumbo v1, "Minutes out of range: "
    ...
    const-string/jumbo v1, "Hours out of range: "
...
.method public static forOffsetMillis(I)Lorg/joda/time/DateTimeZone;
    ...
    const-string/jumbo v2, "Millis out of range: "
...
.method public static forTimeZone(Ljava/util/TimeZone;)Lorg/joda/time/DateTimeZone;
    ...
    .line 7
    invoke-interface {v2, v1}, Lorg/joda/time/tz/d;->a(Ljava/lang/String;)Lorg/joda/time/DateTimeZone;
    ...
    .line 8
    invoke-interface {v2, p0}, Lorg/joda/time/tz/d;->a(Ljava/lang/String;)Lorg/joda/time/DateTimeZone;
    ...
    const-string/jumbo v0, "The TimeZone id must not be null"
...
.method public static getAvailableIDs()Ljava/util/Set;
    ...
    invoke-interface {v0}, Lorg/joda/time/tz/d;->a()Ljava/util/Set;
...
.method private static getDefaultNameProvider()Lorg/joda/time/tz/c;
    .locals 4

    const/4 v0, 0x0

    :try_start_0
    const-string/jumbo v1, "org.joda.time.DateTimeZone.NameProvider"
    ...
    .line 3
    const-class v2, Lorg/joda/time/tz/c;
    ...
    const-string/jumbo v3, "System property referred to class that does not implement "

    invoke-virtual {v2, v3}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-class v3, Lorg/joda/time/tz/c;
    ...
    invoke-direct {v0}, Lorg/joda/time/tz/b;-><init>()V

    :cond_2
    return-object v0
.end method

.method private static getDefaultProvider()Lorg/joda/time/tz/d;
    .locals 3
    ...
    .line 3
    const-class v1, Lorg/joda/time/tz/d;
    ...
    check-cast v0, Lorg/joda/time/tz/d;

    .line 5
    invoke-static {v0}, Lorg/joda/time/DateTimeZone;->validateProvider(Lorg/joda/time/tz/d;)Lorg/joda/time/tz/d;
    ...
    const-string/jumbo v2, "System property referred to class that does not implement "

    invoke-virtual {v1, v2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-class v2, Lorg/joda/time/tz/d;
    ...
    .line 9
    :try_start_4
    new-instance v1, Lorg/joda/time/tz/j;

    new-instance v2, Ljava/io/File;

    invoke-direct {v2, v0}, Ljava/io/File;-><init>(Ljava/lang/String;)V

    invoke-direct {v1, v2}, Lorg/joda/time/tz/j;-><init>(Ljava/io/File;)V

    .line 10
    invoke-static {v1}, Lorg/joda/time/DateTimeZone;->validateProvider(Lorg/joda/time/tz/d;)Lorg/joda/time/tz/d;
    :try_end_4
    ...
    invoke-direct {v0, v1}, Lorg/joda/time/tz/j;-><init>(Ljava/lang/String;)V
...
.method public static getNameProvider()Lorg/joda/time/tz/c;
    .locals 3
    ...
    .line 2
    invoke-static {}, Lorg/joda/time/DateTimeZone;->getDefaultNameProvider()Lorg/joda/time/tz/c;
...
.method public static getProvider()Lorg/joda/time/tz/d;
    .locals 3
    ...
    .line 2
    invoke-static {}, Lorg/joda/time/DateTimeZone;->getDefaultProvider()Lorg/joda/time/tz/d;
...
.method private static parseOffset(Ljava/lang/String;)I
    ...
    .line 1
    sget-object v0, Lorg/joda/time/DateTimeZone$a;->b:Lorg/joda/time/b/b;

    invoke-virtual {v0, p0}, Lorg/joda/time/b/b;->e(Ljava/lang/String;)J
...
.method private static printOffset(I)Ljava/lang/String;
    ...
    .line 5
    invoke-static {v0, v2, v3}, Lorg/joda/time/b/i;->a(Ljava/lang/StringBuffer;II)V
    ...
    .line 12
    invoke-static {v0, v1, v3}, Lorg/joda/time/b/i;->a(Ljava/lang/StringBuffer;II)V
    ...
    .line 15
    invoke-static {v0, p0, v1}, Lorg/joda/time/b/i;->a(Ljava/lang/StringBuffer;II)V
...
.method public static setDefault(Lorg/joda/time/DateTimeZone;)V
    ...
    const-string/jumbo v2, "DateTimeZone.setDefault"
    ...
    const-string/jumbo v0, "The datetime zone must not be null"
...
.method public static setNameProvider(Lorg/joda/time/tz/c;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/SecurityException;
    ...
    const-string/jumbo v2, "DateTimeZone.setNameProvider"
...
.method public static setProvider(Lorg/joda/time/tz/d;)V
    .locals 3
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/lang/SecurityException;
    ...
    const-string/jumbo v2, "DateTimeZone.setProvider"
    ...
    .line 4
    :cond_1
    invoke-static {p0}, Lorg/joda/time/DateTimeZone;->validateProvider(Lorg/joda/time/tz/d;)Lorg/joda/time/tz/d;
...
.method private static validateProvider(Lorg/joda/time/tz/d;)Lorg/joda/time/tz/d;
    .locals 2

    .line 1
    invoke-interface {p0}, Lorg/joda/time/tz/d;->a()Ljava/util/Set;
    ...
    invoke-interface {p0, v1}, Lorg/joda/time/tz/d;->a(Ljava/lang/String;)Lorg/joda/time/DateTimeZone;
    ...
    const-string/jumbo v0, "Invalid UTC zone provided"
    ...
    const-string/jumbo v0, "The provider doesn\'t support UTC"
    ...
    const-string/jumbo v0, "The provider doesn\'t have any available ids"
...
.method public convertLocalToUTC(JZ)J
    ...
    const-string/jumbo p2, "Subtracting time zone offset caused overflow"
...
.method public convertUTCToLocal(J)J
    ...
    const-string/jumbo p2, "Adding time zone offset caused overflow"
...
.method public getName(JLjava/util/Locale;)Ljava/lang/String;
    ...
    .line 5
    :cond_1
    invoke-static {}, Lorg/joda/time/DateTimeZone;->getNameProvider()Lorg/joda/time/tz/c;

    move-result-object v1

    .line 6
    instance-of v2, v1, Lorg/joda/time/tz/b;
    ...
    invoke-virtual {v1, p3, v2, v0, v3}, Lorg/joda/time/tz/b;->a(Ljava/util/Locale;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-interface {v1, p3, v2, v0}, Lorg/joda/time/tz/c;->a(Ljava/util/Locale;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public final getOffset(Lorg/joda/time/m;)I
    .locals 2
...
.method public getShortName(JLjava/util/Locale;)Ljava/lang/String;
    ...
    invoke-virtual {v1, p3, v2, v0, v3}, Lorg/joda/time/tz/b;->b(Ljava/util/Locale;Ljava/lang/String;Ljava/lang/String;Z)Ljava/lang/String;
    ...
    invoke-interface {v1, p3, v2, v0}, Lorg/joda/time/tz/c;->b(Ljava/util/Locale;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method protected writeReplace()Ljava/lang/Object;
    ...
    .line 1
    new-instance v0, Lorg/joda/time/DateTimeZone$b;

    iget-object v1, p0, Lorg/joda/time/DateTimeZone;->iID:Ljava/lang/String;

    invoke-direct {v0, v1}, Lorg/joda/time/DateTimeZone$b;-><init>(Ljava/lang/String;)V
