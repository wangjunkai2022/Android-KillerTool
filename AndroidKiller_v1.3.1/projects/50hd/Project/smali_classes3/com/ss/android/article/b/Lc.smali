...
.field protected O:Lcom/ss/android/article/viewModel/SettingsModel;
...
# direct methods
.method protected constructor <init>(Ljava/lang/Object;Landroid/view/View;ILandroid/view/View;Landroid/widget/ImageView;Lde/hdodenhof/circleimageview/CircleImageView;Lcom/ss/android/article/b/wf;Landroid/widget/LinearLayout;Landroid/widget/TextView;Landroid/widget/TextView;Landroid/widget/TextView;Landroid/widget/TextView;Landroid/widget/TextView;Landroid/widget/TextView;)V
    .locals 0
    ...
    .line 2
    iput-object p4, p0, Lcom/ss/android/article/b/Lc;->D:Landroid/view/View;

    .line 3
    iput-object p5, p0, Lcom/ss/android/article/b/Lc;->E:Landroid/widget/ImageView;

    .line 4
    iput-object p6, p0, Lcom/ss/android/article/b/Lc;->F:Lde/hdodenhof/circleimageview/CircleImageView;

    .line 5
    iput-object p7, p0, Lcom/ss/android/article/b/Lc;->G:Lcom/ss/android/article/b/wf;

    .line 6
    iget-object p1, p0, Lcom/ss/android/article/b/Lc;->G:Lcom/ss/android/article/b/wf;

    invoke-virtual {p0, p1}, Landroid/databinding/ViewDataBinding;->d(Landroid/databinding/ViewDataBinding;)V

    .line 7
    iput-object p8, p0, Lcom/ss/android/article/b/Lc;->H:Landroid/widget/LinearLayout;

    .line 8
    iput-object p9, p0, Lcom/ss/android/article/b/Lc;->I:Landroid/widget/TextView;

    .line 9
    iput-object p10, p0, Lcom/ss/android/article/b/Lc;->J:Landroid/widget/TextView;

    .line 10
    iput-object p11, p0, Lcom/ss/android/article/b/Lc;->K:Landroid/widget/TextView;

    .line 11
    iput-object p12, p0, Lcom/ss/android/article/b/Lc;->L:Landroid/widget/TextView;

    .line 12
    iput-object p13, p0, Lcom/ss/android/article/b/Lc;->M:Landroid/widget/TextView;

    .line 13
    iput-object p14, p0, Lcom/ss/android/article/b/Lc;->N:Landroid/widget/TextView;
...
.method public n()Lcom/ss/android/article/viewModel/SettingsModel;
    ...
    .line 1
    iget-object v0, p0, Lcom/ss/android/article/b/Lc;->O:Lcom/ss/android/article/viewModel/SettingsModel;
