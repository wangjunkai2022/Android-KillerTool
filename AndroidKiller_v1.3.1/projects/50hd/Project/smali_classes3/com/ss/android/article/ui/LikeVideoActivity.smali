.class public Lcom/ss/android/article/ui/LikeVideoActivity;
...
.method static synthetic a(Lcom/ss/android/article/ui/LikeVideoActivity;)Ljava/util/List;
    .locals 0

    .line 1
    iget-object p0, p0, Lcom/ss/android/article/ui/LikeVideoActivity;->j:Ljava/util/List;
...
.method public static a(Landroid/content/Context;Z)V
    ...
    const-class v1, Lcom/ss/android/article/ui/LikeVideoActivity;
...
.method public w()V
    ...
    iput-object v0, p0, Lcom/ss/android/article/ui/LikeVideoActivity;->l:Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/ss/android/article/ui/LikeVideoActivity;->j:Ljava/util/List;

    .line 3
    iget-object v0, p0, Lcom/ss/android/article/ui/LikeVideoActivity;->j:Ljava/util/List;
    ...
    const-string/jumbo v1, "\u62fc\u591a\u591a"

    invoke-interface {v0, v1}, Ljava/util/List;->add(Ljava/lang/Object;)Z

    .line 6
    iget-object v0, p0, Lcom/ss/android/article/ui/LikeVideoActivity;->l:Ljava/util/List;

    iget-boolean v1, p0, Lcom/ss/android/article/ui/LikeVideoActivity;->m:Z

    const-string/jumbo v2, ""

    invoke-static {v1, v2}, Lcom/ss/android/article/ui/fragment/like/LikeVideoFragment;->a(ZLjava/lang/String;)Lcom/ss/android/article/ui/fragment/like/LikeVideoFragment;
    ...
    const-string/jumbo v2, "featuredAv"
    ...
    iget-object v3, p0, Lcom/ss/android/article/ui/LikeVideoActivity;->l:Ljava/util/List;
    ...
    invoke-direct {v1, p0}, Lcom/ss/android/article/ui/Ma;-><init>(Lcom/ss/android/article/ui/LikeVideoActivity;)V

    iput-object v1, p0, Lcom/ss/android/article/ui/LikeVideoActivity;->k:Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/a/a;
    ...
    .line 14
    iget-object v1, p0, Lcom/ss/android/article/ui/LikeVideoActivity;->k:Lnet/lucode/hackware/magicindicator/buildins/commonnavigator/a/a;
...
.method public y()V
    ...
    const-string/jumbo v2, "isLike"

    invoke-virtual {v0, v2, v1}, Landroid/content/Intent;->getBooleanExtra(Ljava/lang/String;Z)Z

    move-result v0

    iput-boolean v0, p0, Lcom/ss/android/article/ui/LikeVideoActivity;->m:Z
    ...
    iput-object v0, p0, Lcom/ss/android/article/ui/LikeVideoActivity;->i:Lcom/ss/android/article/viewModel/FindPassModel;
    ...
    iget-object v1, p0, Lcom/ss/android/article/ui/LikeVideoActivity;->i:Lcom/ss/android/article/viewModel/FindPassModel;
