.class Lcom/ss/android/article/adapter/S;
...
.method constructor <init>(Lcom/ss/android/article/adapter/FindVideoDetailAdapter;Lcom/ss/android/article/bean/findvideo/FindVideoRecommendData$RecommendBean;Lcom/chad/library/adapter/base/BaseViewHolder;)V
    ...
    .line 1
    iput-object p1, p0, Lcom/ss/android/article/adapter/S;->c:Lcom/ss/android/article/adapter/FindVideoDetailAdapter;

    iput-object p2, p0, Lcom/ss/android/article/adapter/S;->a:Lcom/ss/android/article/bean/findvideo/FindVideoRecommendData$RecommendBean;

    iput-object p3, p0, Lcom/ss/android/article/adapter/S;->b:Lcom/chad/library/adapter/base/BaseViewHolder;
...
.method public onClick(Landroid/view/View;)V
    ...
    .line 1
    iget-object p1, p0, Lcom/ss/android/article/adapter/S;->a:Lcom/ss/android/article/bean/findvideo/FindVideoRecommendData$RecommendBean;

    iget-object p1, p1, Lcom/ss/android/article/bean/findvideo/FindVideoRecommendData$RecommendBean;->member:Lcom/ss/android/article/listplayer/adapter/ListLikeVideoBean$MemberBean;
    ...
    .line 3
    iget-object p1, p0, Lcom/ss/android/article/adapter/S;->b:Lcom/chad/library/adapter/base/BaseViewHolder;
    ...
    iget-object v1, p0, Lcom/ss/android/article/adapter/S;->c:Lcom/ss/android/article/adapter/FindVideoDetailAdapter;

    invoke-static {v1}, Lcom/ss/android/article/adapter/FindVideoDetailAdapter;->a(Lcom/ss/android/article/adapter/FindVideoDetailAdapter;)Landroid/content/Context;
    ...
    invoke-static {v1}, Lcom/ss/android/article/adapter/FindVideoDetailAdapter;->b(Lcom/ss/android/article/adapter/FindVideoDetailAdapter;)Landroid/content/Context;
    ...
    iget-object v0, p0, Lcom/ss/android/article/adapter/S;->a:Lcom/ss/android/article/bean/findvideo/FindVideoRecommendData$RecommendBean;
