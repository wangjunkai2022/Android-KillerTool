...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/ss/android/article/b/Nb;->I:Landroid/databinding/ViewDataBinding$b;

    .line 2
    sget-object v0, Lcom/ss/android/article/b/Nb;->I:Landroid/databinding/ViewDataBinding$b;
    ...
    sput-object v0, Lcom/ss/android/article/b/Nb;->J:Landroid/util/SparseIntArray;

    .line 4
    sget-object v0, Lcom/ss/android/article/b/Nb;->J:Landroid/util/SparseIntArray;
...
.method public constructor <init>(Landroid/databinding/e;Landroid/view/View;)V
    ...
    sget-object v1, Lcom/ss/android/article/b/Nb;->J:Landroid/util/SparseIntArray;
...
.method private constructor <init>(Landroid/databinding/e;Landroid/view/View;[Ljava/lang/Object;)V
    ...
    invoke-direct/range {v1 .. v8}, Lcom/ss/android/article/b/Mb;-><init>(Ljava/lang/Object;Landroid/view/View;ILandroid/view/View;Lcom/ss/android/article/b/wf;Landroid/support/v7/widget/RecyclerView;Lcom/scwang/smartrefresh/layout/SmartRefreshLayout;)V

    const-wide/16 v0, -0x1

    .line 3
    iput-wide v0, p0, Lcom/ss/android/article/b/Nb;->L:J
    ...
    iput-object p1, p0, Lcom/ss/android/article/b/Nb;->K:Landroid/widget/LinearLayout;

    .line 5
    iget-object p1, p0, Lcom/ss/android/article/b/Nb;->K:Landroid/widget/LinearLayout;
    ...
    .line 7
    invoke-virtual {p0}, Lcom/ss/android/article/b/Nb;->k()V
...
.method private a(Lcom/ss/android/article/b/wf;I)Z
    ...
    .line 13
    :try_start_0
    iget-wide p1, p0, Lcom/ss/android/article/b/Nb;->L:J

    const-wide/16 v0, 0x1

    or-long/2addr p1, v0

    iput-wide p1, p0, Lcom/ss/android/article/b/Nb;->L:J
...
.method public a(Landroid/arch/lifecycle/LifecycleOwner;)V
    ...
    .line 10
    iget-object v0, p0, Lcom/ss/android/article/b/Mb;->E:Lcom/ss/android/article/b/wf;
...
.method public a(Lcom/ss/android/article/viewModel/MessageModel;)V
    .locals 4
    .param p1    # Lcom/ss/android/article/viewModel/MessageModel;
        .annotation build Landroid/support/annotation/Nullable;
        .end annotation
    .end param

    .line 2
    iput-object p1, p0, Lcom/ss/android/article/b/Mb;->H:Lcom/ss/android/article/viewModel/MessageModel;
    ...
    .line 4
    :try_start_0
    iget-wide v0, p0, Lcom/ss/android/article/b/Nb;->L:J
...
.method public a(ILjava/lang/Object;)Z
    ...
    .line 1
    check-cast p2, Lcom/ss/android/article/viewModel/MessageModel;

    invoke-virtual {p0, p2}, Lcom/ss/android/article/b/Nb;->a(Lcom/ss/android/article/viewModel/MessageModel;)V
...
.method protected a(ILjava/lang/Object;I)Z
    ...
    invoke-direct {p0, p2, p3}, Lcom/ss/android/article/b/Nb;->a(Lcom/ss/android/article/b/wf;I)Z
...
.method protected d()V
    ...
    .line 3
    iput-wide v2, p0, Lcom/ss/android/article/b/Nb;->L:J
    ...
    .line 5
    iget-object v4, p0, Lcom/ss/android/article/b/Mb;->H:Lcom/ss/android/article/viewModel/MessageModel;
