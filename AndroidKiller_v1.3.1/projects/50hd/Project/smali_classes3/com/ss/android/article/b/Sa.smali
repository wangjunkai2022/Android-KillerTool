...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/ss/android/article/b/Sa;->J:Landroid/databinding/ViewDataBinding$b;

    .line 2
    sget-object v0, Lcom/ss/android/article/b/Sa;->J:Landroid/databinding/ViewDataBinding$b;
    ...
    sput-object v0, Lcom/ss/android/article/b/Sa;->K:Landroid/util/SparseIntArray;

    .line 4
    sget-object v0, Lcom/ss/android/article/b/Sa;->K:Landroid/util/SparseIntArray;
...
.method public constructor <init>(Landroid/databinding/e;Landroid/view/View;)V
    ...
    sget-object v1, Lcom/ss/android/article/b/Sa;->K:Landroid/util/SparseIntArray;
...
.method private constructor <init>(Landroid/databinding/e;Landroid/view/View;[Ljava/lang/Object;)V
    ...
    invoke-direct/range {v1 .. v9}, Lcom/ss/android/article/b/Ra;-><init>(Ljava/lang/Object;Landroid/view/View;ILandroid/view/View;Lcom/ss/android/article/b/wf;Landroid/support/v7/widget/RecyclerView;Lcom/scwang/smartrefresh/layout/SmartRefreshLayout;Landroid/widget/TextView;)V

    const-wide/16 v0, -0x1

    .line 3
    iput-wide v0, p0, Lcom/ss/android/article/b/Sa;->M:J
    ...
    iput-object p1, p0, Lcom/ss/android/article/b/Sa;->L:Landroid/widget/LinearLayout;

    .line 5
    iget-object p1, p0, Lcom/ss/android/article/b/Sa;->L:Landroid/widget/LinearLayout;
    ...
    .line 7
    invoke-virtual {p0}, Lcom/ss/android/article/b/Sa;->k()V
...
.method private a(Lcom/ss/android/article/b/wf;I)Z
    ...
    .line 13
    :try_start_0
    iget-wide p1, p0, Lcom/ss/android/article/b/Sa;->M:J

    const-wide/16 v0, 0x1

    or-long/2addr p1, v0

    iput-wide p1, p0, Lcom/ss/android/article/b/Sa;->M:J
...
.method public a(Landroid/arch/lifecycle/LifecycleOwner;)V
    ...
    .line 10
    iget-object v0, p0, Lcom/ss/android/article/b/Ra;->E:Lcom/ss/android/article/b/wf;
...
.method public a(Lcom/ss/android/article/viewModel/GiveMoneyListModel;)V
    .locals 4
    .param p1    # Lcom/ss/android/article/viewModel/GiveMoneyListModel;
        .annotation build Landroid/support/annotation/Nullable;
        .end annotation
    .end param

    .line 2
    iput-object p1, p0, Lcom/ss/android/article/b/Ra;->I:Lcom/ss/android/article/viewModel/GiveMoneyListModel;
    ...
    .line 4
    :try_start_0
    iget-wide v0, p0, Lcom/ss/android/article/b/Sa;->M:J
...
.method public a(ILjava/lang/Object;)Z
    ...
    .line 1
    check-cast p2, Lcom/ss/android/article/viewModel/GiveMoneyListModel;

    invoke-virtual {p0, p2}, Lcom/ss/android/article/b/Sa;->a(Lcom/ss/android/article/viewModel/GiveMoneyListModel;)V
...
.method protected d()V
    ...
    .line 3
    iput-wide v2, p0, Lcom/ss/android/article/b/Sa;->M:J
    ...
    .line 5
    iget-object v4, p0, Lcom/ss/android/article/b/Ra;->I:Lcom/ss/android/article/viewModel/GiveMoneyListModel;
