...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Looper;ZLcom/google/android/gms/common/internal/zzf;Landroid/os/Bundle;Lcom/google/android/gms/common/api/GoogleApiClient$ConnectionCallbacks;Lcom/google/android/gms/common/api/GoogleApiClient$OnConnectionFailedListener;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/signin/internal/zzh;->zzale:Ljava/lang/Integer;
...
.method private zzFN()Lcom/google/android/gms/common/internal/ResolveAccountRequest;
    ...
    invoke-static {v1}, Lcom/google/android/gms/auth/api/signin/internal/zzq;->zzaf(Landroid/content/Context;)Lcom/google/android/gms/auth/api/signin/internal/zzq;
...
.method public zza(Lcom/google/android/gms/common/internal/zzp;Z)V
    ...
    :catch_0
    const-string/jumbo p1, "SignInClientImpl"

    const-string/jumbo p2, "Remote service probably died when saveDefaultAccount is called"
...
.method public zza(Lcom/google/android/gms/signin/internal/zzd;)V
    ...
    check-cast v1, Lcom/google/android/gms/signin/internal/zze;

    new-instance v2, Lcom/google/android/gms/signin/internal/SignInRequest;

    invoke-direct {v2, v0}, Lcom/google/android/gms/signin/internal/SignInRequest;-><init>(Lcom/google/android/gms/common/internal/ResolveAccountRequest;)V

    invoke-interface {v1, v2, p1}, Lcom/google/android/gms/signin/internal/zze;->zza(Lcom/google/android/gms/signin/internal/SignInRequest;Lcom/google/android/gms/signin/internal/zzd;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-interface {p1, v2}, Lcom/google/android/gms/signin/internal/zzd;->zzb(Lcom/google/android/gms/signin/internal/SignInResponse;)V
    :try_end_1
    ...
    :catch_1
    const-string/jumbo p1, "ISignInCallbacks#onSignInComplete should be executed from the same process, unexpected RemoteException."
...
.method protected zzml()Landroid/os/Bundle;
    ...
    iget-object v1, p0, Lcom/google/android/gms/signin/internal/zzh;->zzahz:Lcom/google/android/gms/common/internal/zzf;

    invoke-virtual {v1}, Lcom/google/android/gms/common/internal/zzf;->zzqv()Ljava/lang/String;
