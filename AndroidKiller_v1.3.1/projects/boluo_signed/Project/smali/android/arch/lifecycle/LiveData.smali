...
.field public mObservers:Landroid/arch/core/internal/SafeIterableMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public static assertMainThread(Ljava/lang/String;)V
    ...
    const-string/jumbo p0, " on a background"
...
.method public observe(Landroid/arch/lifecycle/LifecycleOwner;Landroid/arch/lifecycle/Observer;)V
    ...
    const-string/jumbo p2, "Cannot add the same observer with different lifecycles"
...
.method public observeForever(Landroid/arch/lifecycle/Observer;)V
    ...
    const-string/jumbo v0, "Cannot add the same observer with different lifecycles"
    ...
    .line 5
    invoke-virtual {v0, p1}, Landroid/arch/lifecycle/LiveData$ObserverWrapper;->activeStateChanged(Z)V
