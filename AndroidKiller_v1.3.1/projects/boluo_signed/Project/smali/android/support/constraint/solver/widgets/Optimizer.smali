...
.method public static applyChainOptimized(Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;Landroid/support/constraint/solver/LinearSystem;IILandroid/support/constraint/solver/widgets/ChainHead;)Z
    ...
    :cond_1b
    :goto_d
    iget-object v0, v9, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->target:Landroid/support/constraint/solver/widgets/ResolutionAnchor;
    ...
    .line 47
    iget-object v6, v0, Landroid/support/constraint/solver/widgets/ConstraintWidget;->mWeight:[F
    ...
    invoke-virtual {v6, v11, v2}, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->resolve(Landroid/support/constraint/solver/widgets/ResolutionAnchor;F)V
    ...
    .line 58
    iget-wide v5, v3, Landroid/support/constraint/solver/Metrics;->nonresolvedWidgets:J

    sub-long v5, v5, v22

    iput-wide v5, v3, Landroid/support/constraint/solver/Metrics;->nonresolvedWidgets:J

    .line 59
    iget-wide v5, v3, Landroid/support/constraint/solver/Metrics;->resolvedWidgets:J

    add-long v5, v5, v22

    iput-wide v5, v3, Landroid/support/constraint/solver/Metrics;->resolvedWidgets:J

    .line 60
    iget-wide v5, v3, Landroid/support/constraint/solver/Metrics;->chainConnectionResolved:J

    add-long v5, v5, v22

    iput-wide v5, v3, Landroid/support/constraint/solver/Metrics;->chainConnectionResolved:J
    ...
    invoke-virtual {v6, v7, v0}, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->resolve(Landroid/support/constraint/solver/widgets/ResolutionAnchor;F)V
    ...
    invoke-virtual {v5, v13}, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->addResolvedValue(Landroid/support/constraint/solver/LinearSystem;)V
    ...
    .line 74
    iget-wide v7, v0, Landroid/support/constraint/solver/Metrics;->nonresolvedWidgets:J
    ...
    .line 75
    iget-wide v7, v0, Landroid/support/constraint/solver/Metrics;->resolvedWidgets:J
    ...
    .line 76
    iget-wide v7, v0, Landroid/support/constraint/solver/Metrics;->chainConnectionResolved:J
    ...
    iget-object v10, v9, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->resolvedTarget:Landroid/support/constraint/solver/widgets/ResolutionAnchor;

    invoke-virtual {v8, v10, v3}, Landroid/support/constraint/solver/widgets/ResolutionAnchor;->resolve(Landroid/support/constraint/solver/widgets/ResolutionAnchor;F)V
...
.method public static optimizableMatchConstraint(Landroid/support/constraint/solver/widgets/ConstraintWidget;I)Z
    .locals 5
