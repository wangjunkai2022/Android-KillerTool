...
.field public mConstraintSet:Landroid/support/constraint/ConstraintSet;
...
.method private internalMeasureChildren(II)V
    ...
    iget v6, v9, Landroid/support/constraint/ConstraintLayout$LayoutParams;->matchConstraintDefaultWidth:I
...
.method private internalMeasureDimensions(II)V
    ...
    invoke-virtual {v14}, Landroid/support/constraint/solver/widgets/ResolutionNode;->isResolved()Z
    ...
    invoke-virtual {v8}, Landroid/support/constraint/solver/widgets/ResolutionNode;->isResolved()Z
...
.method private setChildrenConstraints()V
    ...
    invoke-virtual {v5}, Landroid/support/constraint/solver/widgets/WidgetContainer;->removeAllChildren()V
    ...
    invoke-virtual {v6, v13}, Landroid/support/constraint/solver/widgets/WidgetContainer;->add(Landroid/support/constraint/solver/widgets/ConstraintWidget;)V
    ...
    .line 112
    invoke-virtual {v13, v7}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setVerticalBiasPercent(F)V
...
.method public onMeasure(II)V
    ...
    invoke-virtual {v9, v7}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setX(I)V

    .line 9
    iget-object v9, v0, Landroid/support/constraint/ConstraintLayout;->mLayoutWidget:Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;

    invoke-virtual {v9, v8}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setY(I)V
    ...
    invoke-virtual {v9, v10}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setMaxWidth(I)V
    ...
    invoke-virtual {v9, v10}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setMaxHeight(I)V
    ...
    iget-boolean v15, v13, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->mGroupsWrapOptimized:Z

    if-eqz v15, :cond_9

    .line 29
    iget-boolean v15, v13, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->mHorizontalWrapOptimized:Z
    ...
    .line 30
    iget v15, v13, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->mWrapFixedWidth:I

    if-ge v15, v4, :cond_6

    .line 31
    invoke-virtual {v13, v15}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setWidth(I)V
    ...
    .line 33
    invoke-virtual {v13, v15}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setHorizontalDimensionBehaviour(Landroid/support/constraint/solver/widgets/ConstraintWidget$DimensionBehaviour;)V

    .line 34
    :cond_7
    iget-object v13, v0, Landroid/support/constraint/ConstraintLayout;->mLayoutWidget:Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;

    iget-boolean v15, v13, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->mVerticalWrapOptimized:Z
    ...
    .line 35
    iget v11, v13, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->mWrapFixedHeight:I

    if-ge v11, v6, :cond_8

    .line 36
    invoke-virtual {v13, v11}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setHeight(I)V
    ...
    .line 38
    invoke-virtual {v11, v13}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setVerticalDimensionBehaviour(Landroid/support/constraint/solver/widgets/ConstraintWidget$DimensionBehaviour;)V
    ...
    iget-boolean v5, v3, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->mHorizontalWrapOptimized:Z

    if-eqz v5, :cond_c

    iget v5, v3, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->mWrapFixedWidth:I
    ...
    iget-boolean v4, v3, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->mVerticalWrapOptimized:Z

    if-eqz v4, :cond_d

    iget v4, v3, Landroid/support/constraint/solver/widgets/ConstraintWidgetContainer;->mWrapFixedHeight:I
    ...
    const-string/jumbo v3, "First pass"
    ...
    invoke-virtual {v1, v4}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setWidth(I)V
    ...
    invoke-virtual {v1, v4}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setHeight(I)V
    ...
    :cond_22
    const-string/jumbo v1, "2nd pass"
    ...
    invoke-virtual {v1, v13}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setWidth(I)V
    ...
    invoke-virtual {v1, v5}, Landroid/support/constraint/solver/widgets/ConstraintWidget;->setHeight(I)V
    ...
    const-string/jumbo v1, "3rd pass"
