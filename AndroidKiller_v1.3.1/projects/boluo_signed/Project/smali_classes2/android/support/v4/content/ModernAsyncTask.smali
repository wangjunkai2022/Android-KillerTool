...
.field public static sHandler:Landroid/support/v4/content/ModernAsyncTask$InternalHandler;
...
.field public volatile mStatus:Landroid/support/v4/content/ModernAsyncTask$Status;

.field public final mTaskInvoked:Ljava/util/concurrent/atomic/AtomicBoolean;

.field public final mWorker:Landroid/support/v4/content/ModernAsyncTask$WorkerRunnable;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/support/v4/content/ModernAsyncTask$WorkerRunnable<",
            "TParams;TResult;>;"
...
.method public final varargs executeOnExecutor(Ljava/util/concurrent/Executor;[Ljava/lang/Object;)Landroid/support/v4/content/ModernAsyncTask;
    ...
    const-string/jumbo p2, "We should never reach this state"
    ...
    const-string/jumbo p2, "Cannot execute task: the task has already been executed (a task can be executed only once)"
    ...
    const-string/jumbo p2, "Cannot execute task: the task is already running."
