...
.field public final mSubscriptions:Landroid/support/v4/util/ArrayMap;
...
.method public static getStateLabel(I)Ljava/lang/String;
    ...
    :cond_0
    const-string/jumbo p0, "CONNECT_STATE_SUSPENDED"

    return-object p0

    :cond_1
    const-string/jumbo p0, "CONNECT_STATE_CONNECTED"

    return-object p0

    :cond_2
    const-string/jumbo p0, "CONNECT_STATE_CONNECTING"

    return-object p0

    :cond_3
    const-string/jumbo p0, "CONNECT_STATE_DISCONNECTED"

    return-object p0

    :cond_4
    const-string/jumbo p0, "CONNECT_STATE_DISCONNECTING"
...
.method private isCurrent(Landroid/os/Messenger;Ljava/lang/String;)Z
    ...
    const-string/jumbo p2, " with mCallbacksMessenger="
    ...
    const-string/jumbo p2, "MediaBrowserCompat"
...
.method public getItem(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserCompat$ItemCallback;)V
    ...
    const-string/jumbo v0, "Not connected, unable to retrieve the MediaItem."
...
.method public onServiceConnected(Landroid/os/Messenger;Ljava/lang/String;Landroid/support/v4/media/session/MediaSessionCompat$Token;Landroid/os/Bundle;)V
    ...
    const-string/jumbo p2, "... ignoring"
    ...
    const-string/jumbo p1, "ServiceCallbacks.onConnect..."
    ...
    :catch_0
    const-string/jumbo p1, "addSubscription failed with RemoteException."
...
.method public sendCustomAction(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$CustomActionCallback;)V
    ...
    const-string/jumbo v2, "Remote error sending a custom action: action="
    ...
    const-string/jumbo v1, "Cannot send a custom action ("
    ...
    const-string/jumbo p1, " because the browser is not connected to the "
...
.method public subscribe(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserCompat$SubscriptionCallback;)V
    ...
    const-string/jumbo p3, "addSubscription failed with RemoteException parentId="
