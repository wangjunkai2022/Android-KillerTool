...
.method public static loadFont(Landroid/content/Context;ILandroid/util/TypedValue;ILandroid/support/v4/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    .locals 8
    .param p0    # Landroid/content/Context;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    ...
    const-string/jumbo p3, "Font resource ID #0x"
    ...
    const-string/jumbo p1, " could not be retrieved."
...
.method public static loadFont(Landroid/content/Context;Landroid/content/res/Resources;Landroid/util/TypedValue;IILandroid/support/v4/content/res/ResourcesCompat$FontCallback;Landroid/os/Handler;Z)Landroid/graphics/Typeface;
    .locals 15
    .param p0    # Landroid/content/Context;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
    ...
    const-string/jumbo v11, "ResourcesCompat"
    ...
    const-string/jumbo v0, "Failed to find font-family tag"
    ...
    const-string/jumbo v2, "Failed to read xml resource "
    ...
    const-string/jumbo v2, "Failed to parse xml resource "
    ...
    const-string/jumbo v0, ") is not a Font: "
