...
# instance fields
.field public final mConnections:Landroid/support/v4/util/ArrayMap;
...
.field public mCurConnection:Landroid/support/v4/media/MediaBrowserServiceCompat$ConnectionRecord;

.field public final mHandler:Landroid/support/v4/media/MediaBrowserServiceCompat$ServiceHandler;

.field public mImpl:Landroid/support/v4/media/MediaBrowserServiceCompat$MediaBrowserServiceImpl;
...
# virtual methods
.method public addSubscription(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserServiceCompat$ConnectionRecord;Landroid/os/IBinder;Landroid/os/Bundle;)V
    .locals 4
...
.method public notifyChildrenChanged(Landroid/support/v4/media/MediaSessionManager$RemoteUserInfo;Ljava/lang/String;Landroid/os/Bundle;)V
    ...
    const-string/jumbo p2, "options cannot be null in notifyChildrenChanged"
...
.method public performCustomAction(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserServiceCompat$ConnectionRecord;Landroid/support/v4/os/ResultReceiver;)V
    .locals 1
    ...
    const-string/jumbo v0, "onCustomAction must call detach() or sendResult() or sendError() before returning for action="
...
.method public performLoadChildren(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserServiceCompat$ConnectionRecord;Landroid/os/Bundle;Landroid/os/Bundle;)V
    .locals 8
    ...
    const-string/jumbo v0, "onLoadChildren must call detach() or sendResult() before returning for package="
...
.method public performLoadItem(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserServiceCompat$ConnectionRecord;Landroid/support/v4/os/ResultReceiver;)V
    .locals 1
    ...
    const-string/jumbo v0, "onLoadItem must call detach() or sendResult() before returning for id="
...
.method public performSearch(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/media/MediaBrowserServiceCompat$ConnectionRecord;Landroid/support/v4/os/ResultReceiver;)V
    .locals 1
    ...
    const-string/jumbo p4, "onSearch must call detach() or sendResult() before returning for query="
...
.method public removeSubscription(Ljava/lang/String;Landroid/support/v4/media/MediaBrowserServiceCompat$ConnectionRecord;Landroid/os/IBinder;)Z
    .locals 6
...
.method public setSessionToken(Landroid/support/v4/media/session/MediaSessionCompat$Token;)V
    ...
    const-string/jumbo v0, "The session token has already been set."
    ...
    const-string/jumbo v0, "Session token may not be null."
