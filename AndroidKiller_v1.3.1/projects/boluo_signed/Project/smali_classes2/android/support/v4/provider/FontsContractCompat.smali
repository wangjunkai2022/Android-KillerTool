...
.field public static final TAG:Ljava/lang/String; = "FontsContractCompat"

.field public static final sBackgroundThread:Landroid/support/v4/provider/SelfDestructiveThread;
...
.field public static final sPendingReplies:Landroid/support/v4/util/SimpleArrayMap;
...
.field public static final sTypefaceCache:Landroid/support/v4/util/LruCache;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method public static getCertificates(Landroid/support/v4/provider/FontRequest;Landroid/content/res/Resources;)Ljava/util/List;
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static getFontFromProvider(Landroid/content/Context;Landroid/support/v4/provider/FontRequest;Ljava/lang/String;Landroid/os/CancellationSignal;)[Landroid/support/v4/provider/FontsContractCompat$FontInfo;
    .locals 20
    .annotation build Landroid/support/annotation/NonNull;
    .end annotation
    ...
    const-string/jumbo v14, "file_id"

    const-string/jumbo v15, "font_ttc_index"

    const-string/jumbo v16, "font_variation_settings"

    const-string/jumbo v17, "font_weight"

    const-string/jumbo v18, "font_italic"
    ...
    const-string/jumbo v7, "font_ttc_index"
    ...
    const-string/jumbo v8, "font_weight"
    ...
    const-string/jumbo v9, "font_italic"
...
.method public static getFontInternal(Landroid/content/Context;Landroid/support/v4/provider/FontRequest;I)Landroid/support/v4/provider/FontsContractCompat$TypefaceResult;
    .locals 3
    .annotation build Landroid/support/annotation/NonNull;
    .end annotation
...
.method public static getProvider(Landroid/content/pm/PackageManager;Landroid/support/v4/provider/FontRequest;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    ...
    const-string/jumbo v1, "Found content provider "

    invoke-virtual {p2, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {p2, v0}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string/jumbo v0, ", but package was not "
    ...
    const-string/jumbo p2, "No package found for authority: "
