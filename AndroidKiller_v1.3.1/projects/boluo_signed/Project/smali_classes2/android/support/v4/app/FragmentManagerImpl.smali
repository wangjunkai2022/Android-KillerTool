...
.method private ensureExecReady(Z)V
    ...
    const-string/jumbo v0, "Fragment host has been destroyed"
...
.method public static getAnimationListener(Landroid/view/animation/Animation;)Landroid/view/animation/Animation$AnimationListener;
    .locals 3
    ...
    const-string/jumbo v1, "Cannot access Animation\'s mListener field"
    ...
    const-string/jumbo v1, "No field with the name mListener is found in Animation class"
...
.method public static makeFadeAnimation(Landroid/content/Context;FF)Landroid/support/v4/app/FragmentManagerImpl$AnimationOrAnimator;
    .locals 0
...
.method public static makeOpenCloseAnimation(Landroid/content/Context;FFFF)Landroid/support/v4/app/FragmentManagerImpl$AnimationOrAnimator;
    .locals 10
...
.method public static modifiesAlpha(Landroid/animation/Animator;)Z
    .locals 5
...
.method public static modifiesAlpha(Landroid/support/v4/app/FragmentManagerImpl$AnimationOrAnimator;)Z
    .locals 4
...
.method public static setHWLayerAnimListenerIfAlpha(Landroid/view/View;Landroid/support/v4/app/FragmentManagerImpl$AnimationOrAnimator;)V
    .locals 3
...
.method public static setRetaining(Landroid/support/v4/app/FragmentManagerNonConfig;)V
    .locals 3
...
.method public static shouldRunOnHWLayer(Landroid/view/View;Landroid/support/v4/app/FragmentManagerImpl$AnimationOrAnimator;)Z
    .locals 3
...
.method private throwException(Ljava/lang/RuntimeException;)V
    ...
    const-string/jumbo v3, "Failed dumping state"
...
# virtual methods
.method public addBackStackState(Landroid/support/v4/app/BackStackRecord;)V
    .locals 1
...
.method public completeExecute(Landroid/support/v4/app/BackStackRecord;ZZZ)V
    .locals 7
...
.method public completeShowHideFragment(Landroid/support/v4/app/Fragment;)V
    .locals 7
...
.method public dispatchOnFragmentActivityCreated(Landroid/support/v4/app/Fragment;Landroid/os/Bundle;Z)V
    .locals 3
    .param p1    # Landroid/support/v4/app/Fragment;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public dispatchOnFragmentAttached(Landroid/support/v4/app/Fragment;Landroid/content/Context;Z)V
    .locals 3
    .param p1    # Landroid/support/v4/app/Fragment;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public dispatchOnFragmentCreated(Landroid/support/v4/app/Fragment;Landroid/os/Bundle;Z)V
    .locals 3
    .param p1    # Landroid/support/v4/app/Fragment;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public dispatchOnFragmentDestroyed(Landroid/support/v4/app/Fragment;Z)V
    .locals 3
    .param p1    # Landroid/support/v4/app/Fragment;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public dispatchOnFragmentDetached(Landroid/support/v4/app/Fragment;Z)V
    .locals 3
    .param p1    # Landroid/support/v4/app/Fragment;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public dispatchOnFragmentPaused(Landroid/support/v4/app/Fragment;Z)V
    .locals 3
    .param p1    # Landroid/support/v4/app/Fragment;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public dispatchOnFragmentPreAttached(Landroid/support/v4/app/Fragment;Landroid/content/Context;Z)V
    .locals 3
    .param p1    # Landroid/support/v4/app/Fragment;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public dispatchOnFragmentPreCreated(Landroid/support/v4/app/Fragment;Landroid/os/Bundle;Z)V
    .locals 3
    .param p1    # Landroid/support/v4/app/Fragment;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public dispatchOnFragmentResumed(Landroid/support/v4/app/Fragment;Z)V
    .locals 3
    .param p1    # Landroid/support/v4/app/Fragment;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public dispatchOnFragmentSaveInstanceState(Landroid/support/v4/app/Fragment;Landroid/os/Bundle;Z)V
    .locals 3
    .param p1    # Landroid/support/v4/app/Fragment;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public dispatchOnFragmentStarted(Landroid/support/v4/app/Fragment;Z)V
    .locals 3
    .param p1    # Landroid/support/v4/app/Fragment;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public dispatchOnFragmentStopped(Landroid/support/v4/app/Fragment;Z)V
    .locals 3
    .param p1    # Landroid/support/v4/app/Fragment;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public dispatchOnFragmentViewCreated(Landroid/support/v4/app/Fragment;Landroid/view/View;Landroid/os/Bundle;Z)V
    .locals 3
    .param p1    # Landroid/support/v4/app/Fragment;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public dispatchOnFragmentViewDestroyed(Landroid/support/v4/app/Fragment;Z)V
    .locals 3
    .param p1    # Landroid/support/v4/app/Fragment;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public dump(Ljava/lang/String;Ljava/io/FileDescriptor;Ljava/io/PrintWriter;[Ljava/lang/String;)V
    ...
    const-string/jumbo v3, "Added Fragments:"
    ...
    const-string/jumbo v3, "Fragments Created Menus:"
    ...
    const-string/jumbo v3, "Back Stack:"
    ...
    const-string/jumbo p1, "  mNoTransactionsBecause="
...
.method public ensureInflatedFragmentView(Landroid/support/v4/app/Fragment;)V
    .locals 3
...
.method public loadAnimation(Landroid/support/v4/app/Fragment;IZI)Landroid/support/v4/app/FragmentManagerImpl$AnimationOrAnimator;
    .locals 4
...
.method public makeActive(Landroid/support/v4/app/Fragment;)V
    .locals 2
...
.method public makeInactive(Landroid/support/v4/app/Fragment;)V
    .locals 3
...
.method public moveToState(Landroid/support/v4/app/Fragment;)V
    .locals 6
...
.method public moveToState(Landroid/support/v4/app/Fragment;IIIZ)V
    .locals 16
    ...
    .line 112
    iput-object v13, v7, Landroid/support/v4/app/Fragment;->mViewLifecycleOwner:Landroid/arch/lifecycle/LifecycleOwner;

    .line 113
    iget-object v0, v7, Landroid/support/v4/app/Fragment;->mViewLifecycleOwnerLiveData:Landroid/arch/lifecycle/MutableLiveData;

    invoke-virtual {v0, v13}, Landroid/arch/lifecycle/MutableLiveData;->setValue(Ljava/lang/Object;)V
...
.method public restoreAllState(Landroid/os/Parcelable;Landroid/support/v4/app/FragmentManagerNonConfig;)V
    ...
    const-string/jumbo v11, "Could not find active fragment with index "
    ...
    const-string/jumbo v10, "android:view_state"
    ...
    const-string/jumbo v6, "Re-attaching retained fragment "

    invoke-virtual {v5, v6}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v5, v4}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string/jumbo v6, " target no longer exists: "
...
.method public retainNonConfig()Landroid/support/v4/app/FragmentManagerNonConfig;
    .locals 1
...
.method public saveAllState()Landroid/os/Parcelable;
    ...
    const-string/jumbo v12, "Failure saving state: "

    invoke-virtual {v8, v12}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {v8, v11}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string/jumbo v12, " has target not in fragment manager: "
    ...
    const-string/jumbo v12, "android:target_req_state"
    ...
    const-string/jumbo v8, "Saved state of "
...
.method public saveFragmentBasicState(Landroid/support/v4/app/Fragment;)Landroid/os/Bundle;
    .locals 3
...
.method public saveFragmentViewState(Landroid/support/v4/app/Fragment;)V
    .locals 2
