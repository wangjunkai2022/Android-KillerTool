...
.field public static final STRAIGHT_PATH_MOTION:Landroid/support/transition/PathMotion;
...
.field public mEndValues:Landroid/support/transition/TransitionValuesMaps;
...
.field public mEpicenterCallback:Landroid/support/transition/Transition$EpicenterCallback;
...
.field public mNameOverrides:Landroid/support/v4/util/ArrayMap;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Landroid/support/v4/util/ArrayMap<",
            "Ljava/lang/String;",
...
.field public mParent:Landroid/support/transition/TransitionSet;

.field public mPathMotion:Landroid/support/transition/PathMotion;

.field public mPaused:Z

.field public mPropagation:Landroid/support/transition/TransitionPropagation;

.field public mSceneRoot:Landroid/view/ViewGroup;

.field public mStartDelay:J

.field public mStartValues:Landroid/support/transition/TransitionValuesMaps;
...
.method public static addViewValues(Landroid/support/transition/TransitionValuesMaps;Landroid/view/View;Landroid/support/transition/TransitionValues;)V
    .locals 3
...
.method public static getRunningAnimators()Landroid/support/v4/util/ArrayMap;
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
...
.method public static isValueChanged(Landroid/support/transition/TransitionValues;Landroid/support/transition/TransitionValues;Ljava/lang/String;)Z
    .locals 0
...
.method public capturePropagationValues(Landroid/support/transition/TransitionValues;)V
    .locals 5
...
.method public createAnimators(Landroid/view/ViewGroup;Landroid/support/transition/TransitionValuesMaps;Landroid/support/transition/TransitionValuesMaps;Ljava/util/ArrayList;Ljava/util/ArrayList;)V
    .locals 20
    .annotation build Landroid/support/annotation/RestrictTo;
        value = {
            .enum Landroid/support/annotation/RestrictTo$Scope;->LIBRARY_GROUP:Landroid/support/annotation/RestrictTo$Scope;
...
.method public getMatchedTransitionValues(Landroid/view/View;Z)Landroid/support/transition/TransitionValues;
    .locals 6
    ...
    .line 2
    invoke-virtual {v0, p1, p2}, Landroid/support/transition/Transition;->getMatchedTransitionValues(Landroid/view/View;Z)Landroid/support/transition/TransitionValues;
...
.method public setSceneRoot(Landroid/view/ViewGroup;)Landroid/support/transition/Transition;
    .locals 0
