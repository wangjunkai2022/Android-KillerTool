...
.field public static final TAG:Ljava/lang/String; = "Chip"


# instance fields
.field public chipDrawable:Landroid/support/design/chip/ChipDrawable;
...
.field public final fontCallback:Landroid/support/v4/content/res/ResourcesCompat$FontCallback;
...
.field public final touchHelper:Landroid/support/design/chip/Chip$ChipTouchHelper;
...
.method public static synthetic access$000(Landroid/support/design/chip/Chip;)Landroid/support/design/chip/ChipDrawable;
    .locals 0
...
.method public static synthetic access$100(Landroid/support/design/chip/Chip;)Z
    .locals 0
...
.method public static synthetic access$200(Landroid/support/design/chip/Chip;)Landroid/graphics/RectF;
    .locals 0
...
.method public static synthetic access$300(Landroid/support/design/chip/Chip;)Landroid/graphics/Rect;
    .locals 0
...
.method private handleAccessibilityExit(Landroid/view/MotionEvent;)Z
    ...
    const-string/jumbo v1, "Unable to send Accessibility Exit event"
    ...
    const-string/jumbo p1, "mHoveredVirtualViewId"
...
.method private validateAttributes(Landroid/util/AttributeSet;)V
    ...
    const-string/jumbo v2, "Please set end drawable using R.attr#closeIcon."
    ...
    const-string/jumbo p1, "Chip"

    const-string/jumbo v0, "Chip text must be vertically center and start aligned"
    ...
    const-string/jumbo v0, "Chip does not support multi-line text"
    ...
    const-string/jumbo v0, "Please set start drawable using R.attr#chipIcon."
    ...
    const-string/jumbo v0, "Please set left drawable using R.attr#chipIcon."
    ...
    const-string/jumbo v0, "Do not set the background; Chip manages its own background drawable."
...
.method public setBackgroundColor(I)V
    ...
    const-string/jumbo v0, "Do not set the background color; Chip manages its own background drawable."
...
.method public setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    const-string/jumbo v0, "Do not set the background drawable; Chip manages its own background drawable."
...
.method public setBackgroundResource(I)V
    ...
    const-string/jumbo v0, "Do not set the background resource; Chip manages its own background drawable."
...
.method public setBackgroundTintList(Landroid/content/res/ColorStateList;)V
    ...
    const-string/jumbo v0, "Do not set the background tint list; Chip manages its own background drawable."
...
.method public setBackgroundTintMode(Landroid/graphics/PorterDuff$Mode;)V
    ...
    const-string/jumbo v0, "Do not set the background tint mode; Chip manages its own background drawable."
...
.method public setCompoundDrawables(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    const-string/jumbo p2, "Please set end drawable using R.attr#closeIcon."
    ...
    const-string/jumbo p2, "Please set start drawable using R.attr#chipIcon."
...
.method public setCompoundDrawablesWithIntrinsicBounds(Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;Landroid/graphics/drawable/Drawable;)V
    ...
    const-string/jumbo p2, "Please set right drawable using R.attr#closeIcon."
    ...
    const-string/jumbo p2, "Please set left drawable using R.attr#chipIcon."
...
.method public setEllipsize(Landroid/text/TextUtils$TruncateAt;)V
    ...
    const-string/jumbo v0, "Text within a chip are not allowed to scroll."
