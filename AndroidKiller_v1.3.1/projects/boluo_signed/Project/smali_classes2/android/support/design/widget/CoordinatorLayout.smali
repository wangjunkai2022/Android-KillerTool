...
.field public static final sRectPool:Landroid/support/v4/util/Pools$Pool;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
# instance fields
.field public mApplyWindowInsetsListener:Landroid/support/v4/view/OnApplyWindowInsetsListener;

.field public mBehaviorTouchView:Landroid/view/View;

.field public final mChildDag:Landroid/support/v4/widget/DirectedAcyclicGraph;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public mLastInsets:Landroid/support/v4/view/WindowInsetsCompat;

.field public mNeedsPreDrawListener:Z

.field public final mNestedScrollingParentHelper:Landroid/support/v4/view/NestedScrollingParentHelper;
...
.field public mOnPreDrawListener:Landroid/support/design/widget/CoordinatorLayout$OnPreDrawListener;
...
.method private getKeyline(I)I
    ...
    const-string/jumbo p1, " out of range for "
...
.method private offsetChildByInset(Landroid/view/View;Landroid/graphics/Rect;I)V
    ...
    const-string/jumbo p3, "Rect should be within the child\'s bounds. Rect:"
...
.method public static parseBehavior(Landroid/content/Context;Landroid/util/AttributeSet;Ljava/lang/String;)Landroid/support/design/widget/CoordinatorLayout$Behavior;
    .locals 4
    ...
    const-string/jumbo v1, "Could not inflate Behavior subclass "
...
.method private performIntercept(Landroid/view/MotionEvent;I)Z
    ...
    .line 15
    :cond_7
    invoke-virtual {v12}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->didBlockInteraction()Z

    move-result v9

    .line 16
    invoke-virtual {v12, v0, v11}, Landroid/support/design/widget/CoordinatorLayout$LayoutParams;->isBlockingInteractionBelow(Landroid/support/design/widget/CoordinatorLayout;Landroid/view/View;)Z
...
.method public generateDefaultLayoutParams()Landroid/support/design/widget/CoordinatorLayout$LayoutParams;
    .locals 2
...
.method public generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/support/design/widget/CoordinatorLayout$LayoutParams;
    .locals 1
...
.method public getResolvedLayoutParams(Landroid/view/View;)Landroid/support/design/widget/CoordinatorLayout$LayoutParams;
    .locals 6
    ...
    const-string/jumbo v1, "Attached behavior class is null"
    ...
    const-string/jumbo v1, " could not be instantiated. Did you forget"

    invoke-virtual {v4, v1}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    const-string/jumbo v1, " a default constructor?"
...
.method public onLayoutChild(Landroid/view/View;I)V
    ...
    const-string/jumbo p2, "An anchor may not be changed after CoordinatorLayout measurement begins before layout is complete."
...
.method public final setWindowInsets(Landroid/support/v4/view/WindowInsetsCompat;)Landroid/support/v4/view/WindowInsetsCompat;
    .locals 3
