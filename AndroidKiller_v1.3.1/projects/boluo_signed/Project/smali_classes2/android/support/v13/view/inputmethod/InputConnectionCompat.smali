...
.method public static commitContent(Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;Landroid/support/v13/view/inputmethod/InputContentInfoCompat;ILandroid/os/Bundle;)Z
    ...
    const-string/jumbo v1, "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_URI"
    ...
    const-string/jumbo v1, "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_DESCRIPTION"
    ...
    const-string/jumbo p2, "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_FLAGS"

    .line 11
    invoke-virtual {p1, p2, p3}, Landroid/os/Bundle;->putInt(Ljava/lang/String;I)V

    const-string/jumbo p2, "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_OPTS"

    .line 12
    invoke-virtual {p1, p2, p4}, Landroid/os/Bundle;->putParcelable(Ljava/lang/String;Landroid/os/Parcelable;)V

    const-string/jumbo p2, "android.support.v13.view.inputmethod.InputConnectionCompat.COMMIT_CONTENT"
...
.method public static createWrapper(Landroid/view/inputmethod/InputConnection;Landroid/view/inputmethod/EditorInfo;Landroid/support/v13/view/inputmethod/InputConnectionCompat$OnCommitContentListener;)Landroid/view/inputmethod/InputConnection;
    ...
    const-string/jumbo p1, "onCommitContentListener must be non-null"
    ...
    const-string/jumbo p1, "editorInfo must be non-null"
    ...
    const-string/jumbo p1, "inputConnection must be non-null"
...
.method public static handlePerformPrivateCommand(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v13/view/inputmethod/InputConnectionCompat$OnCommitContentListener;)Z
    .locals 7
    ...
    :try_start_0
    const-string/jumbo v1, "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_RESULT_RECEIVER"
    ...
    :try_start_1
    const-string/jumbo v2, "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_URI"
    ...
    const-string/jumbo v3, "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_DESCRIPTION"
    ...
    const-string/jumbo v4, "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_LINK_URI"
    ...
    const-string/jumbo v5, "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_FLAGS"
    ...
    const-string/jumbo v6, "android.support.v13.view.inputmethod.InputConnectionCompat.CONTENT_OPTS"
