...
.method public static doInstallation(Landroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    :try_start_7
    const-string/jumbo p5, "MultiDex"

    const-string/jumbo v3, "Failed to install extracted secondary dex files, retrying with forced extraction"
...
.method public static installInstrumentation(Landroid/content/Context;Landroid/content/Context;)V
    ...
    const-string/jumbo v0, "Installing instrumentation"
    ...
    const-string/jumbo v0, "VM has multidex support, MultiDex support library is disabled."
    ...
    const-string/jumbo v0, "No ApplicationInfo available for instrumentation, i.e. running on a test Context: MultiDex support library is disabled."
    ...
    const-string/jumbo v0, "No ApplicationInfo available, i.e. running on a test Context: MultiDex support library is disabled."
    ...
    invoke-static/range {v6 .. v11}, Landroid/support/multidex/MultiDex;->doInstallation(Landroid/content/Context;Ljava/io/File;Ljava/io/File;Ljava/lang/String;Ljava/lang/String;Z)V
    ...
    const-string/jumbo v0, "Installation done"
    ...
    const-string/jumbo v3, "MultiDex installation failed ("
    ...
    const-string/jumbo v4, " is unsupported. Min SDK version is "
