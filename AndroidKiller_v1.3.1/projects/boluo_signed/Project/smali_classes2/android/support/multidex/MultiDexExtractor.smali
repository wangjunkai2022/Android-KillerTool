...
.field public static final DEX_PREFIX:Ljava/lang/String; = "classes"

.field public static final DEX_SUFFIX:Ljava/lang/String; = ".dex"

.field public static final EXTRACTED_NAME_EXT:Ljava/lang/String; = ".classes"

.field public static final EXTRACTED_SUFFIX:Ljava/lang/String; = ".zip"

.field public static final KEY_CRC:Ljava/lang/String; = "crc"

.field public static final KEY_DEX_CRC:Ljava/lang/String; = "dex.crc."

.field public static final KEY_DEX_NUMBER:Ljava/lang/String; = "dex.number"

.field public static final KEY_DEX_TIME:Ljava/lang/String; = "dex.time."

.field public static final KEY_TIME_STAMP:Ljava/lang/String; = "timestamp"

.field public static final LOCK_FILENAME:Ljava/lang/String; = "MultiDex.lock"

.field public static final MAX_EXTRACT_ATTEMPTS:I = 0x3

.field public static final NO_VALUE:J = -0x1L

.field public static final PREFS_FILE:Ljava/lang/String; = "multidex.version"
...
.field public final sourceApk:Ljava/io/File;

.field public final sourceCrc:J
...
.method public constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    const-string/jumbo v1, "MultiDexExtractor("
    ...
    const-string/jumbo v0, "Blocking on lock "
    ...
    invoke-static {p2}, Landroid/support/multidex/MultiDexExtractor;->closeQuietly(Ljava/io/Closeable;)V
...
.method private clearDexDir()V
    ...
    iget-object v2, p0, Landroid/support/multidex/MultiDexExtractor;->dexDir:Ljava/io/File;
...
.method public static extract(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    .locals 5
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Ljava/io/IOException;,
    ...
    const-string/jumbo v0, "Renaming to "
...
.method public static getMultiDexPreferences(Landroid/content/Context;)Landroid/content/SharedPreferences;
    .locals 2
...
.method private loadExistingExtractions(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    const-string/jumbo v13, "dex.time."
    ...
    const-string/jumbo v1, "\"), expected modification time: "
    ...
    const-string/jumbo v1, ", expected crc: "
    ...
    const-string/jumbo v3, "Missing extracted secondary dex file \'"
...
.method private performExtractions()Ljava/util/List;
    ...
    iget-object v0, v1, Landroid/support/multidex/MultiDexExtractor;->sourceApk:Ljava/io/File;
    ...
    invoke-direct {v11, v12, v0}, Landroid/support/multidex/MultiDexExtractor$ExtractedDex;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    const-string/jumbo v15, "Failed to read crc from "
    ...
    const-string/jumbo v15, "Extraction "
    ...
    const-string/jumbo v4, "Could not create zip file "
    ...
    const-string/jumbo v4, " for secondary dex ("
...
.method public static putStoredApkInfo(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    const-string/jumbo p3, "dex.number"
    ...
    const-string/jumbo p6, "dex.time."
...
.method public load(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    ...
    const-string/jumbo v1, "MultiDexExtractor.load("
    ...
    const-string/jumbo v0, "Failed to reload existing extracted secondary dex files, falling back to fresh extraction"
    ...
    const-string/jumbo p3, "Forced extraction must be performed."
    ...
    :cond_1
    const-string/jumbo p3, "Detected that extraction must be performed."
    ...
    const-string/jumbo p2, "load found "
    ...
    const-string/jumbo p2, " secondary dex files"
