...
.field public final mHideSelector:Landroid/support/v7/widget/ListPopupWindow$ListSelectorHider;
...
.field public final mResizePopupRunnable:Landroid/support/v7/widget/ListPopupWindow$ResizePopupRunnable;

.field public final mScrollListener:Landroid/support/v7/widget/ListPopupWindow$PopupScrollListener;

.field public mShowDropDownRunnable:Ljava/lang/Runnable;

.field public final mTempRect:Landroid/graphics/Rect;

.field public final mTouchInterceptor:Landroid/support/v7/widget/ListPopupWindow$PopupTouchInterceptor;
...
.method public static constructor <clinit>()V
    ...
    :catch_0
    const-string/jumbo v3, "Could not find method setClipToScreenEnabled() on PopupWindow. Oh well."
    ...
    const-string/jumbo v5, "getMaxAvailableHeight"
    ...
    :catch_1
    const-string/jumbo v3, "Could not find method getMaxAvailableHeight(View, int, boolean) on PopupWindow. Oh well."
...
.method private getMaxAvailableHeight(Landroid/view/View;IZ)I
    ...
    :catch_0
    const-string/jumbo p3, "ListPopupWindow"

    const-string/jumbo v0, "Could not call getMaxAvailableHeightMethod(View, int, boolean) on PopupWindow. Using the public version."
...
.method private setPopupClipToScreenEnabled(Z)V
    ...
    :catch_0
    const-string/jumbo p1, "ListPopupWindow"

    const-string/jumbo v0, "Could not call setClipToScreenEnabled() on PopupWindow. Oh well."
...
.method public createDropDownListView(Landroid/content/Context;Z)Landroid/support/v7/widget/DropDownListView;
    .locals 1
    .annotation build Landroid/support/annotation/NonNull;
    .end annotation
