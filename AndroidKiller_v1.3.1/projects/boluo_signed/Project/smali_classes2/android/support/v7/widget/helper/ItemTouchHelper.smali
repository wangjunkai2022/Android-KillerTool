...
.field public mCallback:Landroid/support/v7/widget/helper/ItemTouchHelper$Callback;
...
.field public mGestureDetector:Landroid/support/v4/view/GestureDetectorCompat;

.field public mInitialTouchX:F

.field public mInitialTouchY:F

.field public mItemTouchHelperGestureListener:Landroid/support/v7/widget/helper/ItemTouchHelper$ItemTouchHelperGestureListener;

.field public mMaxSwipeVelocity:F

.field public final mOnItemTouchListener:Landroid/support/v7/widget/RecyclerView$OnItemTouchListener;
...
.field public mSelected:Landroid/support/v7/widget/RecyclerView$ViewHolder;
...
.method public endRecoverAnimation(Landroid/support/v7/widget/RecyclerView$ViewHolder;Z)V
    .locals 3
...
.method public findAnimation(Landroid/view/MotionEvent;)Landroid/support/v7/widget/helper/ItemTouchHelper$RecoverAnimation;
    .locals 4
...
.method public moveIfNecessary(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    .locals 10
...
.method public postDispatchSwipe(Landroid/support/v7/widget/helper/ItemTouchHelper$RecoverAnimation;I)V
    .locals 2
...
.method public select(Landroid/support/v7/widget/RecyclerView$ViewHolder;I)V
    .locals 23
...
.method public startDrag(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    const-string/jumbo v1, "ItemTouchHelper"

    if-nez v0, :cond_0

    const-string/jumbo p1, "Start drag has been called but dragging is not enabled"
    ...
    const-string/jumbo p1, "Start drag has been called with a view holder which is not a child of the RecyclerView which is controlled by this ItemTouchHelper."
...
.method public startSwipe(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    const-string/jumbo p1, "Start swipe has been called but swiping is not enabled"
    ...
    const-string/jumbo p1, "Start swipe has been called with a view holder which is not a child of the RecyclerView controlled by this ItemTouchHelper."
