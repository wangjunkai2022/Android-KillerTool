...
# instance fields
.field public mAccessibilityDelegate:Landroid/support/v7/widget/RecyclerViewAccessibilityDelegate;

.field public final mAccessibilityManager:Landroid/view/accessibility/AccessibilityManager;

.field public mActiveOnItemTouchListener:Landroid/support/v7/widget/RecyclerView$OnItemTouchListener;

.field public mAdapter:Landroid/support/v7/widget/RecyclerView$Adapter;

.field public mAdapterHelper:Landroid/support/v7/widget/AdapterHelper;

.field public mAdapterUpdateDuringMeasure:Z

.field public mBottomGlow:Landroid/widget/EdgeEffect;

.field public mChildDrawingOrderCallback:Landroid/support/v7/widget/RecyclerView$ChildDrawingOrderCallback;
...
.field public mEdgeEffectFactory:Landroid/support/v7/widget/RecyclerView$EdgeEffectFactory;
...
.field public mGapWorker:Landroid/support/v7/widget/GapWorker;
...
.field public mItemAnimator:Landroid/support/v7/widget/RecyclerView$ItemAnimator;

.field public mItemAnimatorListener:Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemAnimatorListener;
...
.field public final mObserver:Landroid/support/v7/widget/RecyclerView$RecyclerViewDataObserver;
...
.field public mOnFlingListener:Landroid/support/v7/widget/RecyclerView$OnFlingListener;
...
.field public mPrefetchRegistry:Landroid/support/v7/widget/GapWorker$LayoutPrefetchRegistryImpl;

.field public mPreserveFocusAfterLayout:Z

.field public final mRecycler:Landroid/support/v7/widget/RecyclerView$Recycler;

.field public mRecyclerListener:Landroid/support/v7/widget/RecyclerView$RecyclerListener;
...
.field public mScrollListener:Landroid/support/v7/widget/RecyclerView$OnScrollListener;
...
.field public mScrollingChildHelper:Landroid/support/v4/view/NestedScrollingChildHelper;

.field public final mState:Landroid/support/v7/widget/RecyclerView$State;
...
.field public final mViewFlinger:Landroid/support/v7/widget/RecyclerView$ViewFlinger;

.field public final mViewInfoProcessCallback:Landroid/support/v7/widget/ViewInfoStore$ProcessCallback;

.field public final mViewInfoStore:Landroid/support/v7/widget/ViewInfoStore;
...
.method public static clearNestedRecyclerViewIfNotNested(Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    .locals 3
...
.method private handleMissingPreInfoForChangeError(JLandroid/support/v7/widget/RecyclerView$ViewHolder;Landroid/support/v7/widget/RecyclerView$ViewHolder;)V
    ...
    const-string/jumbo p2, "Problem while matching changed view holders with the newones. The pre-layout information for the change holder "

    invoke-virtual {p1, p2}, Ljava/lang/StringBuilder;->append(Ljava/lang/String;)Ljava/lang/StringBuilder;

    invoke-virtual {p1, p4}, Ljava/lang/StringBuilder;->append(Ljava/lang/Object;)Ljava/lang/StringBuilder;

    const-string/jumbo p2, " cannot be found but it is necessary for "
...
.method public animateAppearance(Landroid/support/v7/widget/RecyclerView$ViewHolder;Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V
    .locals 1
    .param p1    # Landroid/support/v7/widget/RecyclerView$ViewHolder;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public animateDisappearance(Landroid/support/v7/widget/RecyclerView$ViewHolder;Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V
    .locals 1
    .param p1    # Landroid/support/v7/widget/RecyclerView$ViewHolder;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
...
.method public dispatchLayout()V
    ...
    const-string/jumbo v0, "No adapter attached; skipping layout"
    ...
    const-string/jumbo v0, "No layout manager attached; skipping layout"
...
.method public final fillRemainingScrollValues(Landroid/support/v7/widget/RecyclerView$State;)V
    .locals 3
...
.method public fling(II)Z
    ...
    const-string/jumbo p2, "Cannot fling without a LayoutManager set. Call setLayoutManager with a non-null argument."
...
.method public getAdapterPositionFor(Landroid/support/v7/widget/RecyclerView$ViewHolder;)I
    .locals 1
...
.method public getItemDecorationAt(I)Landroid/support/v7/widget/RecyclerView$ItemDecoration;
    ...
    const-string/jumbo p1, " is an invalid index for size "
...
.method public onInterceptTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    const-string/jumbo v0, "Error processing scroll; pointer index for id "
    ...
    const-string/jumbo v0, " not found. Did any MotionEvents get skipped?"
...
.method public recordAnimationInfoIfBouncedHiddenView(Landroid/support/v7/widget/RecyclerView$ViewHolder;Landroid/support/v7/widget/RecyclerView$ItemAnimator$ItemHolderInfo;)V
    .locals 3
...
.method public scrollBy(II)V
    ...
    const-string/jumbo p2, "Cannot scroll without a LayoutManager set. Call setLayoutManager with a non-null argument."
...
.method public scrollTo(II)V
    ...
    const-string/jumbo p2, "RecyclerView does not support scrolling to an absolute position. Use scrollToPosition instead"
...
.method public scrollToPosition(I)V
    ...
    const-string/jumbo v0, "Cannot scroll to position a LayoutManager set. Call setLayoutManager with a non-null argument."
...
.method public setChildImportantForAccessibilityInternal(Landroid/support/v7/widget/RecyclerView$ViewHolder;I)Z
    .locals 1
    .annotation build Landroid/support/annotation/VisibleForTesting;
    .end annotation
...
.method public setScrollingTouchSlop(I)V
    ...
    const-string/jumbo p1, "; using default value"
...
.method public smoothScrollBy(IILandroid/view/animation/Interpolator;)V
    ...
    const-string/jumbo p2, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument."
...
.method public smoothScrollToPosition(I)V
    ...
    const-string/jumbo v0, "Cannot smooth scroll without a LayoutManager set. Call setLayoutManager with a non-null argument."
