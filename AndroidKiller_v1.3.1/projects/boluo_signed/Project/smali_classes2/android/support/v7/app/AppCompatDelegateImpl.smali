.class public Landroid/support/v7/app/AppCompatDelegateImpl;
...
.field public static final KEY_LOCAL_NIGHT_MODE:Ljava/lang/String; = "appcompat:local_night_mode"
...
.field public mActionMenuPresenterCallback:Landroid/support/v7/app/AppCompatDelegateImpl$ActionMenuPresenterCallback;

.field public mActionMode:Landroid/support/v7/view/ActionMode;

.field public mActionModePopup:Landroid/widget/PopupWindow;

.field public mActionModeView:Landroid/support/v7/widget/ActionBarContextView;

.field public final mAppCompatCallback:Landroid/support/v7/app/AppCompatCallback;

.field public mAppCompatViewInflater:Landroid/support/v7/app/AppCompatViewInflater;

.field public final mAppCompatWindowCallback:Landroid/view/Window$Callback;

.field public mApplyDayNightCalled:Z

.field public mAutoNightModeManager:Landroid/support/v7/app/AppCompatDelegateImpl$AutoNightModeManager;

.field public mClosingActionMenu:Z

.field public final mContext:Landroid/content/Context;

.field public mDecorContentParent:Landroid/support/v7/widget/DecorContentParent;

.field public mEnableDefaultActionBarUp:Z

.field public mFadeAnim:Landroid/support/v4/view/ViewPropertyAnimatorCompat;
...
.field public final mOriginalWindowCallback:Landroid/view/Window$Callback;

.field public mOverlayActionBar:Z

.field public mOverlayActionMode:Z

.field public mPanelMenuPresenterCallback:Landroid/support/v7/app/AppCompatDelegateImpl$PanelMenuPresenterCallback;

.field public mPanels:[Landroid/support/v7/app/AppCompatDelegateImpl$PanelFeatureState;

.field public mPreparedPanel:Landroid/support/v7/app/AppCompatDelegateImpl$PanelFeatureState;
...
.method public constructor <init>(Landroid/content/Context;Landroid/view/Window;Landroid/support/v7/app/AppCompatCallback;)V
    ...
    const-string/jumbo p2, "AppCompat has already installed itself into the Window"
...
.method private onKeyUpPanel(ILandroid/view/KeyEvent;)Z
    ...
    :cond_7
    const-string/jumbo p2, "AppCompatDelegate"

    const-string/jumbo v0, "Couldn\'t get audio manager"
...
.method private sanitizeWindowFeatureId(I)I
    ...
    const-string/jumbo p1, "You should now use the AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR id when requesting this feature."
    ...
    const-string/jumbo p1, "You should now use the AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY id when requesting this feature."
...
.method public callOnPanelClosed(ILandroid/support/v7/app/AppCompatDelegateImpl$PanelFeatureState;Landroid/view/Menu;)V
    .locals 2
...
.method public checkCloseActionMenu(Landroid/support/v7/view/menu/MenuBuilder;)V
    .locals 2
...
.method public closePanel(Landroid/support/v7/app/AppCompatDelegateImpl$PanelFeatureState;Z)V
    .locals 3
...
.method public createView(Landroid/view/View;Ljava/lang/String;Landroid/content/Context;Landroid/util/AttributeSet;)Landroid/view/View;
    ...
    const-string/jumbo v0, ". Falling back to default."
...
.method public findMenuPanel(Landroid/view/Menu;)Landroid/support/v7/app/AppCompatDelegateImpl$PanelFeatureState;
    .locals 5
...
.method public final getAutoNightModeManager()Landroid/support/v7/app/AppCompatDelegateImpl$AutoNightModeManager;
    .locals 1
...
.method public getPanelState(IZ)Landroid/support/v7/app/AppCompatDelegateImpl$PanelFeatureState;
    .locals 3
...
.method public onSaveInstanceState(Landroid/os/Bundle;)V
    ...
    const-string/jumbo v1, "appcompat:local_night_mode"
...
.method public final peekSupportActionBar()Landroid/support/v7/app/ActionBar;
    .locals 1
...
.method public setLocalNightMode(I)V
    ...
    const-string/jumbo p1, "AppCompatDelegate"
...
.method public setSupportActionBar(Landroid/support/v7/widget/Toolbar;)V
    ...
    const-string/jumbo v0, "This Activity already has an action bar supplied by the window decor. Do not request Window.FEATURE_SUPPORT_ACTION_BAR and set windowActionBar to false in your theme to use a Toolbar instead."
...
.method public startSupportActionMode(Landroid/support/v7/view/ActionMode$Callback;)Landroid/support/v7/view/ActionMode;
    ...
    const-string/jumbo v0, "ActionMode callback can not be null."
...
.method public startSupportActionModeFromWindow(Landroid/support/v7/view/ActionMode$Callback;)Landroid/support/v7/view/ActionMode;
    .locals 7
    .param p1    # Landroid/support/v7/view/ActionMode$Callback;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
