...
# static fields
.field public static final COLORFILTER_COLOR_BACKGROUND_MULTIPLY:[I

.field public static final COLORFILTER_COLOR_CONTROL_ACTIVATED:[I

.field public static final COLORFILTER_TINT_COLOR_CONTROL_NORMAL:[I

.field public static final COLOR_FILTER_CACHE:Landroid/support/v7/widget/AppCompatDrawableManager$ColorFilterLruCache;

.field public static final DEBUG:Z = false

.field public static final DEFAULT_MODE:Landroid/graphics/PorterDuff$Mode;

.field public static INSTANCE:Landroid/support/v7/widget/AppCompatDrawableManager; = null
...
.field public static final TINT_CHECKABLE_BUTTON_LIST:[I

.field public static final TINT_COLOR_CONTROL_NORMAL:[I

.field public static final TINT_COLOR_CONTROL_STATE_LIST:[I


# instance fields
.field public mDelegates:Landroid/support/v4/util/ArrayMap;
...
.field public mKnownDrawableIdTags:Landroid/support/v4/util/SparseArrayCompat;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.method private checkVectorDrawableSetup(Landroid/content/Context;)V
    ...
    const-string/jumbo v0, "This app has been built with an incorrect configuration. Please configure your build for VectorDrawableCompat."
...
.method public static getTintMode(I)Landroid/graphics/PorterDuff$Mode;
    .locals 1
...
.method public static installDefaultInflateDelegates(Landroid/support/v7/widget/AppCompatDrawableManager;)V
    .locals 2
...
.method private loadDrawableFromDelegates(Landroid/content/Context;I)Landroid/graphics/drawable/Drawable;
    ...
    const-string/jumbo v0, "No start tag found"
    ...
    const-string/jumbo v1, "Exception while inflating drawable"
...
.method public static tintDrawable(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/TintInfo;[I)V
    ...
    const-string/jumbo p0, "AppCompatDrawableManag"

    const-string/jumbo p1, "Mutated drawable is not the same instance as the input."
...
.method public static tintDrawableUsingColorFilter(Landroid/content/Context;ILandroid/graphics/drawable/Drawable;)Z
    .locals 6
...
.method public declared-synchronized onDrawableLoadedFromResources(Landroid/content/Context;Landroid/support/v7/widget/VectorEnabledTintResources;I)Landroid/graphics/drawable/Drawable;
    .locals 1
    .param p1    # Landroid/content/Context;
        .annotation build Landroid/support/annotation/NonNull;
        .end annotation
