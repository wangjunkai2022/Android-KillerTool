.class public Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI$4;
...
.field public final synthetic val$_properties:Lorg/json/JSONObject;
...
.method public constructor <init>(Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI;Lorg/json/JSONObject;Ljava/lang/String;)V
    ...
    iput-object p2, p0, Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI$4;->val$_properties:Lorg/json/JSONObject;

    iput-object p3, p0, Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI$4;->val$eventName:Ljava/lang/String;
...
.method public run()V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI$4;->val$_properties:Lorg/json/JSONObject;

    const-string/jumbo v1, "$is_channel_callback_event"
    ...
    invoke-static {v2}, Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI;->access$400(Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI;)Landroid/content/Context;

    move-result-object v2

    iget-object v3, p0, Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI$4;->val$eventName:Ljava/lang/String;
    ...
    .line 12
    iget-object v3, p0, Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI$4;->val$_properties:Lorg/json/JSONObject;
    ...
    const-string/jumbo v0, "android_id=%s##imei=%s##imei_old=%s##imei_slot1=%s##imei_slot2=%s##imei_meid=%s##mac=%s##oaid=%s"
    ...
    .line 15
    invoke-static {v2}, Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI;->access$500(Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI;)Ljava/lang/String;
    ...
    iget-object v5, p0, Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI$4;->this$0:Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI;

    .line 17
    invoke-static {v5}, Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI;->access$400(Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI;)Landroid/content/Context;
    ...
    iget-object v3, p0, Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI$4;->this$0:Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI;

    .line 19
    invoke-static {v3}, Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI;->access$400(Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI;)Landroid/content/Context;
    ...
    .line 24
    iget-object v1, p0, Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI$4;->val$_properties:Lorg/json/JSONObject;

    const-string/jumbo v2, "$channel_device_info"
    ...
    iget-object v2, p0, Lcom/sensorsdata/analytics/android/sdk/SensorsDataAPI$4;->val$eventName:Ljava/lang/String;
