...
# static fields
.field public static final ACTIVITY_START_COUNT:I = 0x2

.field public static final APP_END_DATA:I = 0x4

.field public static final APP_PAUSED_TIME:I = 0x5

.field public static final APP_START_TIME:I = 0x3

.field public static final EVENTS:I = 0x1

.field public static final LOGIN_ID:I = 0x7

.field public static final SESSION_INTERVAL_TIME:I = 0x6

.field public static authority:Ljava/lang/String;

.field public static uriMatcher:Landroid/content/UriMatcher;


# instance fields
.field public contentResolver:Landroid/content/ContentResolver;

.field public dbHelper:Lcom/sensorsdata/analytics/android/sdk/data/SensorsDataDBHelper;

.field public isDbWritable:Z

.field public persistentAppEndData:Lcom/sensorsdata/analytics/android/sdk/data/persistent/PersistentAppEndData;

.field public persistentAppPaused:Lcom/sensorsdata/analytics/android/sdk/data/persistent/PersistentAppPaused;

.field public persistentAppStartTime:Lcom/sensorsdata/analytics/android/sdk/data/persistent/PersistentAppStartTime;

.field public persistentLoginId:Lcom/sensorsdata/analytics/android/sdk/data/persistent/PersistentLoginId;

.field public persistentSessionIntervalTime:Lcom/sensorsdata/analytics/android/sdk/data/persistent/PersistentSessionIntervalTime;
...
.method private insert(ILandroid/net/Uri;Landroid/content/ContentValues;)V
    ...
    const-string/jumbo p2, "events_login_id"
    ...
    const-string/jumbo v0, "session_interval_time"
    ...
    const-string/jumbo p2, "app_end_time"
    ...
    const-string/jumbo p2, "app_end_data"
    ...
    :pswitch_5
    const-string/jumbo p1, "activity_started_count"
...
.method private query(I)Landroid/database/Cursor;
    ...
    const-string/jumbo p1, "session_interval_time"
    ...
    const-string/jumbo p1, "app_end_time"
    ...
    const-string/jumbo p1, "app_end_data"
...
.method public onCreate()Z
    ...
    :catch_0
    const-string/jumbo v0, "com.sensorsdata.analytics.android.sdk.test"
    ...
    const-string/jumbo v7, ".SensorsDataContentProvider"
    ...
    sput-object v0, Lcom/sensorsdata/analytics/android/sdk/data/SensorsDataContentProvider;->authority:Ljava/lang/String;
    ...
    iput-object v0, v1, Lcom/sensorsdata/analytics/android/sdk/data/SensorsDataContentProvider;->contentResolver:Landroid/content/ContentResolver;

    .line 5
    sget-object v0, Lcom/sensorsdata/analytics/android/sdk/data/SensorsDataContentProvider;->uriMatcher:Landroid/content/UriMatcher;

    sget-object v7, Lcom/sensorsdata/analytics/android/sdk/data/SensorsDataContentProvider;->authority:Ljava/lang/String;

    const-string/jumbo v8, "events"

    invoke-virtual {v0, v7, v8, v5}, Landroid/content/UriMatcher;->addURI(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    const-string/jumbo v10, "activity_started_count"

    invoke-virtual {v0, v7, v10, v9}, Landroid/content/UriMatcher;->addURI(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    const-string/jumbo v11, "app_end_data"

    invoke-virtual {v0, v7, v11, v9}, Landroid/content/UriMatcher;->addURI(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    const-string/jumbo v12, "app_end_time"

    invoke-virtual {v0, v7, v12, v9}, Landroid/content/UriMatcher;->addURI(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    const-string/jumbo v13, "session_interval_time"

    invoke-virtual {v0, v7, v13, v9}, Landroid/content/UriMatcher;->addURI(Ljava/lang/String;Ljava/lang/String;I)V
    ...
    const-string/jumbo v14, "events_login_id"

    invoke-virtual {v0, v7, v14, v9}, Landroid/content/UriMatcher;->addURI(Ljava/lang/String;Ljava/lang/String;I)V
