...
.field public static volatile instance:Lcom/sensorsdata/analytics/android/sdk/data/PersistentLoader;

.field public static storedPreferences:Ljava/util/concurrent/Future;
...
.method public static loadPersistent(Ljava/lang/String;)Lcom/sensorsdata/analytics/android/sdk/data/persistent/PersistentIdentity;
    ...
    :sswitch_0
    const-string/jumbo v2, "app_end_time"
    ...
    :sswitch_1
    const-string/jumbo v2, "app_end_data"
    ...
    :sswitch_2
    const-string/jumbo v2, "first_track_installation"
    ...
    :sswitch_3
    const-string/jumbo v2, "sensorsdata_sdk_configuration"
    ...
    :sswitch_4
    const-string/jumbo v2, "app_start_time"
    ...
    :sswitch_5
    const-string/jumbo v2, "events_distinct_id"
    ...
    :sswitch_6
    const-string/jumbo v2, "first_day"
    ...
    :sswitch_7
    const-string/jumbo v2, "first_start"
    ...
    :sswitch_8
    const-string/jumbo v2, "first_track_installation_with_callback"
    ...
    :sswitch_9
    const-string/jumbo v2, "super_properties"
    ...
    :sswitch_a
    const-string/jumbo v2, "session_interval_time"
    ...
    :sswitch_b
    const-string/jumbo v2, "events_login_id"
    ...
    const-string/jumbo v0, "you should call \'PersistentLoader.initLoader(Context)\' first"
