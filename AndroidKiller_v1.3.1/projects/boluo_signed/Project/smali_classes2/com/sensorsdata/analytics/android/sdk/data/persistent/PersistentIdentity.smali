...
# static fields
.field public static final TAG:Ljava/lang/String; = "SA.PersistentIdentity"
...
.field public final loadStoredPreferences:Ljava/util/concurrent/Future;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public final persistentKey:Ljava/lang/String;

.field public final serializer:Lcom/sensorsdata/analytics/android/sdk/data/persistent/PersistentIdentity$PersistentSerializer;
...
.method public commit(Ljava/lang/Object;)V
    ...
    :try_start_1
    const-string/jumbo v2, "SA.PersistentIdentity"

    const-string/jumbo v3, "Cannot read distinct ids from sharedPreferences."
