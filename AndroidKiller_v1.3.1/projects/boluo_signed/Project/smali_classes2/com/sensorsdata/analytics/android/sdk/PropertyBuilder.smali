...
# static fields
.field public static final TAG:Ljava/lang/String; = "PropertyBuilder"


# instance fields
.field public final innerPropertyMap:Ljava/util/LinkedHashMap;
...
.method public varargs append([Ljava/lang/Object;)Lcom/sensorsdata/analytics/android/sdk/PropertyBuilder;
    ...
    const-string/jumbo v0, "PropertyBuilder"
    ...
    const-string/jumbo v4, "this element key[index= "
    ...
    const-string/jumbo v1, "] will be ignored, because no element can pair with it. "
    ...
    const-string/jumbo v3, "] is not a String, the method will ignore the element and the next element. "
    ...
    :cond_4
    :goto_2
    const-string/jumbo p1, "The key value pair is incorrect."
