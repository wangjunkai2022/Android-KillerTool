...
# static fields
.field public static final MAX_CLASS_NAME_CACHE_SIZE:I = 0xff

.field public static final TAG:Ljava/lang/String; = "SA.Snapshot"


# instance fields
.field public final mClassnameCache:Lcom/sensorsdata/analytics/android/sdk/ViewSnapshot$ClassNameCache;

.field public mLastImageHashArray:[Ljava/lang/String;
...
.field public final mResourceIds:Lcom/sensorsdata/analytics/android/sdk/ResourceIds;

.field public final mRootViewFinder:Lcom/sensorsdata/analytics/android/sdk/ViewSnapshot$RootViewFinder;

.field public mSnapInfo:Lcom/sensorsdata/analytics/android/sdk/visual/SnapInfo;
...
.method private addProperties(Landroid/util/JsonWriter;Landroid/view/View;)V
    ...
    const-string/jumbo v5, "clickable"
...
.method private snapshotView(Landroid/util/JsonWriter;Landroid/view/View;I)V
    ...
    const-string/jumbo v0, "element_level"
    ...
    const-string/jumbo v0, "element_position"
    ...
    const-string/jumbo v0, "element_content"
    ...
    :cond_4
    const-string/jumbo p3, "sa_id_name"
    ...
    const-string/jumbo v1, "layoutRules"
    ...
    :cond_d
    const-string/jumbo p3, "subviews"
...
.method public declared-synchronized snapshots(Lcom/sensorsdata/analytics/android/sdk/UIThreadSet;Ljava/io/OutputStream;)Lcom/sensorsdata/analytics/android/sdk/visual/SnapInfo;
    ...
    const-string/jumbo v3, "Exception thrown during screenshot attempt"
    ...
    const-string/jumbo v3, "Screenshot took more than 1 second to be scheduled and executed. No screenshot will be sent."
    ...
    const-string/jumbo v3, "Screenshot interrupted, no screenshot will be sent."
    ...
    .line 16
    iget-object v4, v6, Lcom/sensorsdata/analytics/android/sdk/ViewSnapshot$RootViewInfo;->activityName:Ljava/lang/String;

    .line 17
    iget-object v5, v6, Lcom/sensorsdata/analytics/android/sdk/ViewSnapshot$RootViewInfo;->activityTitle:Ljava/lang/String;
    ...
    const-string/jumbo v7, "\"serialized_objects\":"
    ...
    const-string/jumbo v8, "rootObject"
    ...
    const-string/jumbo v7, "\"image_hash\":"
    ...
    iput-object v4, p1, Lcom/sensorsdata/analytics/android/sdk/visual/SnapInfo;->screenName:Ljava/lang/String;

    .line 43
    iget-object p1, p0, Lcom/sensorsdata/analytics/android/sdk/ViewSnapshot;->mSnapInfo:Lcom/sensorsdata/analytics/android/sdk/visual/SnapInfo;

    iput-object v5, p1, Lcom/sensorsdata/analytics/android/sdk/visual/SnapInfo;->title:Ljava/lang/String;
