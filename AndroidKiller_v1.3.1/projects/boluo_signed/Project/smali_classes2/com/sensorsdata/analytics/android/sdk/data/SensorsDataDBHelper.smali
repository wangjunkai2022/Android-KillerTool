.class public Lcom/sensorsdata/analytics/android/sdk/data/SensorsDataDBHelper;
...
.field public static final TAG:Ljava/lang/String; = "SA.SQLiteOpenHelper"
...
.method public static constructor <clinit>()V
    ...
    const-string/jumbo v6, "CREATE TABLE %s (_id INTEGER PRIMARY KEY AUTOINCREMENT, %s TEXT NOT NULL, %s INTEGER NOT NULL);"
    ...
    const-string/jumbo v1, "CREATE INDEX IF NOT EXISTS time_idx ON %s (%s);"
...
.method public onCreate(Landroid/database/sqlite/SQLiteDatabase;)V
    ...
    const-string/jumbo v0, "SA.SQLiteOpenHelper"

    const-string/jumbo v1, "Creating a new Sensors Analytics DB"
...
.method public onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    const-string/jumbo p2, "SA.SQLiteOpenHelper"

    const-string/jumbo p3, "Upgrading app, replacing Sensors Analytics DB"
    ...
    const-string/jumbo p3, "DROP TABLE IF EXISTS %s"
