.class public Lcom/tencent/ijk/media/player/IjkMediaMeta;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;
    }
.end annotation
...
.field public static final IJKM_KEY_BITRATE_INDEX:Ljava/lang/String; = "bitrate_index"
...
.field public static final IJKM_KEY_M3U8:Ljava/lang/String; = "m3u8"

.field public static final IJKM_KEY_PROGRAMS:Ljava/lang/String; = "programs"
...
# instance fields
.field public mAudioStream:Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;

.field public mBitrate:J

.field public mBitrateItems:Ljava/util/ArrayList;
...
.field public mVideoStream:Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/tencent/ijk/media/player/IjkMediaMeta;->mStreams:Ljava/util/ArrayList;

    return-void
.end method

.method public static parse(Landroid/os/Bundle;)Lcom/tencent/ijk/media/player/IjkMediaMeta;
    .locals 13
    ...
    .line 1
    :cond_0
    new-instance v0, Lcom/tencent/ijk/media/player/IjkMediaMeta;

    invoke-direct {v0}, Lcom/tencent/ijk/media/player/IjkMediaMeta;-><init>()V

    .line 2
    iput-object p0, v0, Lcom/tencent/ijk/media/player/IjkMediaMeta;->mMediaMeta:Landroid/os/Bundle;

    const-string p0, "format"

    .line 3
    invoke-virtual {v0, p0}, Lcom/tencent/ijk/media/player/IjkMediaMeta;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object p0

    iput-object p0, v0, Lcom/tencent/ijk/media/player/IjkMediaMeta;->mFormat:Ljava/lang/String;

    const-string p0, "duration_us"

    .line 4
    invoke-virtual {v0, p0}, Lcom/tencent/ijk/media/player/IjkMediaMeta;->getLong(Ljava/lang/String;)J

    move-result-wide v1

    iput-wide v1, v0, Lcom/tencent/ijk/media/player/IjkMediaMeta;->mDurationUS:J
    ...
    iput-wide v1, v0, Lcom/tencent/ijk/media/player/IjkMediaMeta;->mStartUS:J
    ...
    iput-wide v1, v0, Lcom/tencent/ijk/media/player/IjkMediaMeta;->mBitrate:J
    ...
    .line 7
    invoke-virtual {v0, v1, v2}, Lcom/tencent/ijk/media/player/IjkMediaMeta;->getInt(Ljava/lang/String;I)I
    ...
    .line 8
    invoke-virtual {v0, v4, v2}, Lcom/tencent/ijk/media/player/IjkMediaMeta;->getInt(Ljava/lang/String;I)I
    ...
    .line 9
    invoke-virtual {v0, v6, v2}, Lcom/tencent/ijk/media/player/IjkMediaMeta;->getInt(Ljava/lang/String;I)I

    const-string v6, "streams"

    .line 10
    invoke-virtual {v0, v6}, Lcom/tencent/ijk/media/player/IjkMediaMeta;->getParcelableArrayList(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    iput-object v7, v0, Lcom/tencent/ijk/media/player/IjkMediaMeta;->mBitrateItems:Ljava/util/ArrayList;
    ...
    .line 13
    :cond_2
    new-instance v10, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;

    invoke-direct {v10, v2}, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;-><init>(I)V

    .line 14
    iput-object v7, v10, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mMeta:Landroid/os/Bundle;

    const-string v7, "type"

    .line 15
    invoke-virtual {v10, v7}, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getString(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v7

    iput-object v7, v10, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mType:Ljava/lang/String;
    ...
    iput-object v7, v10, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mLanguage:Ljava/lang/String;

    .line 17
    iget-object v7, v10, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mType:Ljava/lang/String;
    ...
    iput-object v7, v10, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mCodecName:Ljava/lang/String;
    ...
    iput-object v7, v10, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mCodecProfile:Ljava/lang/String;
    ...
    iput-object v7, v10, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mCodecLongName:Ljava/lang/String;

    .line 21
    invoke-virtual {v10, p0}, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;)I

    move-result v7

    int-to-long v11, v7

    iput-wide v11, v10, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mBitrate:J
    ...
    .line 23
    invoke-virtual {v10, v9}, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;)I

    move-result v7

    iput v7, v10, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mWidth:I

    .line 24
    invoke-virtual {v10, v8}, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;)I

    move-result v7

    iput v7, v10, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mHeight:I

    const-string v7, "fps_num"

    .line 25
    invoke-virtual {v10, v7}, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getInt(Ljava/lang/String;)I

    move-result v7

    iput v7, v10, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mFpsNum:I
    ...
    iput v7, v10, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mFpsDen:I
    ...
    iput v7, v10, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mTbrNum:I
    ...
    iput v7, v10, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mTbrDen:I
    ...
    iput v7, v10, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mSarNum:I
    ...
    iput v7, v10, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mSarDen:I

    if-ne v3, v2, :cond_5

    .line 31
    iput-object v10, v0, Lcom/tencent/ijk/media/player/IjkMediaMeta;->mVideoStream:Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;
    ...
    iput v7, v10, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mSampleRate:I

    const-string v7, "channel_layout"

    .line 34
    invoke-virtual {v10, v7}, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->getLong(Ljava/lang/String;)J

    move-result-wide v7

    iput-wide v7, v10, Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;->mChannelLayout:J

    if-ne v5, v2, :cond_5

    .line 35
    iput-object v10, v0, Lcom/tencent/ijk/media/player/IjkMediaMeta;->mAudioStream:Lcom/tencent/ijk/media/player/IjkMediaMeta$IjkStreamMeta;

    .line 36
    :cond_5
    :goto_1
    iget-object v7, v0, Lcom/tencent/ijk/media/player/IjkMediaMeta;->mStreams:Ljava/util/ArrayList;
    ...
    .line 37
    invoke-virtual {v0, v1}, Lcom/tencent/ijk/media/player/IjkMediaMeta;->getParcelableArrayList(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    .line 39
    :cond_8
    new-instance v3, Lcom/tencent/ijk/media/player/IjkBitrateItem;

    invoke-direct {v3}, Lcom/tencent/ijk/media/player/IjkBitrateItem;-><init>()V

    const-string v4, "0"

    const-string v5, "bitrate_index"
    ...
    iput v5, v3, Lcom/tencent/ijk/media/player/IjkBitrateItem;->index:I

    .line 41
    invoke-virtual {v2, v9, v4}, Landroid/os/Bundle;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput v5, v3, Lcom/tencent/ijk/media/player/IjkBitrateItem;->width:I

    .line 42
    invoke-virtual {v2, v8, v4}, Landroid/os/Bundle;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput v5, v3, Lcom/tencent/ijk/media/player/IjkBitrateItem;->height:I

    .line 43
    invoke-virtual {v2, p0, v4}, Landroid/os/Bundle;->getString(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    iput v2, v3, Lcom/tencent/ijk/media/player/IjkBitrateItem;->bitrate:I

    .line 44
    iget-object v2, v0, Lcom/tencent/ijk/media/player/IjkMediaMeta;->mBitrateItems:Ljava/util/ArrayList;
...
.method public getDurationInline()Ljava/lang/String;
    ...
    .line 1
    iget-wide v0, p0, Lcom/tencent/ijk/media/player/IjkMediaMeta;->mDurationUS:J
...
.method public getInt(Ljava/lang/String;)I
    ...
    .line 1
    invoke-virtual {p0, p1, v0}, Lcom/tencent/ijk/media/player/IjkMediaMeta;->getInt(Ljava/lang/String;I)I
...
.method public getInt(Ljava/lang/String;I)I
    ...
    .line 2
    invoke-virtual {p0, p1}, Lcom/tencent/ijk/media/player/IjkMediaMeta;->getString(Ljava/lang/String;)Ljava/lang/String;
...
.method public getLong(Ljava/lang/String;)J
    ...
    .line 1
    invoke-virtual {p0, p1, v0, v1}, Lcom/tencent/ijk/media/player/IjkMediaMeta;->getLong(Ljava/lang/String;J)J
...
.method public getMetaM3U8()Ljava/util/Map;
    .locals 4
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "()",
    ...
    .line 2
    iget-object v1, p0, Lcom/tencent/ijk/media/player/IjkMediaMeta;->mMediaMeta:Landroid/os/Bundle;
    ...
    .line 4
    iget-object v3, p0, Lcom/tencent/ijk/media/player/IjkMediaMeta;->mMediaMeta:Landroid/os/Bundle;
...
.method public getParcelableArrayList(Ljava/lang/String;)Ljava/util/ArrayList;
    ...
    .line 1
    iget-object v0, p0, Lcom/tencent/ijk/media/player/IjkMediaMeta;->mMediaMeta:Landroid/os/Bundle;
