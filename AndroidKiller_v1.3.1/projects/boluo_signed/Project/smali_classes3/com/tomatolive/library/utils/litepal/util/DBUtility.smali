.class public Lcom/tomatolive/library/utils/litepal/util/DBUtility;
...
.method public static convertOrderByClauseToValidName(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 8
    :cond_0
    invoke-static {v5}, Lcom/tomatolive/library/utils/litepal/util/DBUtility;->convertOrderByItem(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 10
    :cond_2
    invoke-static {p0}, Lcom/tomatolive/library/utils/litepal/util/DBUtility;->convertOrderByItem(Ljava/lang/String;)Ljava/lang/String;
...
.method public static convertOrderByItem(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0}, Lcom/tomatolive/library/utils/litepal/util/DBUtility;->convertToValidColumnName(Ljava/lang/String;)Ljava/lang/String;
...
.method public static convertToValidColumnName(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 1
    invoke-static {p0}, Lcom/tomatolive/library/utils/litepal/util/DBUtility;->isFieldNameConflictWithSQLiteKeywords(Ljava/lang/String;)Z
...
.method public static convertWhereClauseToColumnName(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 9
    invoke-static {v4}, Lcom/tomatolive/library/utils/litepal/util/DBUtility;->convertToValidColumnName(Ljava/lang/String;)Ljava/lang/String;
...
.method public static findAllTableNames(Landroid/database/sqlite/SQLiteDatabase;)Ljava/util/List;
    ...
    invoke-direct {v0, p0}, Lcom/tomatolive/library/utils/litepal/exceptions/DatabaseGenerateException;-><init>(Ljava/lang/String;)V
...
.method public static findPragmaTableInfo(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase;)Lcom/tomatolive/library/utils/litepal/tablemanager/model/TableModel;
    .locals 7

    .line 1
    invoke-static {p0, p1}, Lcom/tomatolive/library/utils/litepal/util/DBUtility;->isTableExists(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase;)Z
    ...
    .line 2
    invoke-static {p0, p1}, Lcom/tomatolive/library/utils/litepal/util/DBUtility;->findUniqueColumns(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase;)Ljava/util/List;
    ...
    .line 4
    invoke-virtual {v1, p0}, Lcom/tomatolive/library/utils/litepal/tablemanager/model/TableModel;->setTableName(Ljava/lang/String;)V
    ...
    .line 8
    :cond_0
    new-instance p0, Lcom/tomatolive/library/utils/litepal/tablemanager/model/ColumnModel;

    invoke-direct {p0}, Lcom/tomatolive/library/utils/litepal/tablemanager/model/ColumnModel;-><init>()V
    ...
    .line 14
    invoke-virtual {p0, p1}, Lcom/tomatolive/library/utils/litepal/tablemanager/model/ColumnModel;->setColumnName(Ljava/lang/String;)V

    .line 15
    invoke-virtual {p0, v3}, Lcom/tomatolive/library/utils/litepal/tablemanager/model/ColumnModel;->setColumnType(Ljava/lang/String;)V

    .line 16
    invoke-virtual {p0, v5}, Lcom/tomatolive/library/utils/litepal/tablemanager/model/ColumnModel;->setNullable(Z)V

    .line 17
    invoke-virtual {p0, v4}, Lcom/tomatolive/library/utils/litepal/tablemanager/model/ColumnModel;->setUnique(Z)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 19
    :cond_2
    invoke-virtual {p0, p1}, Lcom/tomatolive/library/utils/litepal/tablemanager/model/ColumnModel;->setDefaultValue(Ljava/lang/String;)V

    .line 20
    invoke-virtual {v1, p0}, Lcom/tomatolive/library/utils/litepal/tablemanager/model/TableModel;->addColumnModel(Lcom/tomatolive/library/utils/litepal/tablemanager/model/ColumnModel;)V
    ...
    invoke-direct {p1, p0}, Lcom/tomatolive/library/utils/litepal/exceptions/DatabaseGenerateException;-><init>(Ljava/lang/String;)V
...
.method public static findUniqueColumns(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase;)Ljava/util/List;
    ...
    .line 14
    new-instance p0, Lcom/tomatolive/library/utils/litepal/exceptions/DatabaseGenerateException;

    invoke-virtual {p1}, Ljava/lang/Exception;->getMessage()Ljava/lang/String;

    move-result-object p1

    invoke-direct {p0, p1}, Lcom/tomatolive/library/utils/litepal/exceptions/DatabaseGenerateException;-><init>(Ljava/lang/String;)V
...
.method public static isTableExists(Ljava/lang/String;Landroid/database/sqlite/SQLiteDatabase;)Z
    ...
    .line 1
    :try_start_0
    invoke-static {p1}, Lcom/tomatolive/library/utils/litepal/util/DBUtility;->findAllTableNames(Landroid/database/sqlite/SQLiteDatabase;)Ljava/util/List;

    move-result-object p1

    invoke-static {p1, p0}, Lcom/tomatolive/library/utils/litepal/util/BaseUtility;->containsIgnoreCases(Ljava/util/Collection;Ljava/lang/String;)Z
