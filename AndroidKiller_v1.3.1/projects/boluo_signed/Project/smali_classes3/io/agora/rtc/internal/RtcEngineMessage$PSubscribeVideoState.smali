.class public Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeVideoState;
...
.method public marshall()[B
    ...
    .line 2
    iget-object v0, p0, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeVideoState;->channel:Ljava/lang/String;

    invoke-virtual {v0}, Ljava/lang/String;->getBytes()[B

    move-result-object v0

    invoke-virtual {p0, v0}, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeVideoState;->pushBytes([B)V

    .line 3
    iget v0, p0, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeVideoState;->uid:I

    invoke-virtual {p0, v0}, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeVideoState;->pushInt(I)V

    .line 4
    iget v0, p0, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeVideoState;->oldstate:I

    invoke-virtual {p0, v0}, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeVideoState;->pushInt(I)V

    .line 5
    iget v0, p0, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeVideoState;->newstate:I

    invoke-virtual {p0, v0}, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeVideoState;->pushInt(I)V

    .line 6
    iget v0, p0, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeVideoState;->elapsed:I
...
.method public unmarshall([B)V
    ...
    .line 3
    invoke-virtual {p0}, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeVideoState;->popString16UTF8()Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeVideoState;->channel:Ljava/lang/String;

    .line 4
    invoke-virtual {p0}, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeVideoState;->popInt()I

    move-result p1

    iput p1, p0, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeVideoState;->uid:I
    ...
    iput p1, p0, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeVideoState;->oldstate:I
    ...
    iput p1, p0, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeVideoState;->newstate:I
    ...
    iput p1, p0, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeVideoState;->elapsed:I
