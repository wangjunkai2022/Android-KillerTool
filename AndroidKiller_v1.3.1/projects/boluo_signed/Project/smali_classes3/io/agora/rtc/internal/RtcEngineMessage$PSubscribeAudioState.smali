.class public Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeAudioState;
...
.method public marshall()[B
    ...
    .line 2
    iget-object v0, p0, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeAudioState;->channel:Ljava/lang/String;

    invoke-virtual {v0}, Ljava/lang/String;->getBytes()[B

    move-result-object v0

    invoke-virtual {p0, v0}, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeAudioState;->pushBytes([B)V

    .line 3
    iget v0, p0, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeAudioState;->uid:I

    invoke-virtual {p0, v0}, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeAudioState;->pushInt(I)V

    .line 4
    iget v0, p0, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeAudioState;->oldstate:I

    invoke-virtual {p0, v0}, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeAudioState;->pushInt(I)V

    .line 5
    iget v0, p0, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeAudioState;->newstate:I

    invoke-virtual {p0, v0}, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeAudioState;->pushInt(I)V

    .line 6
    iget v0, p0, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeAudioState;->elapsed:I
...
.method public unmarshall([B)V
    ...
    .line 3
    invoke-virtual {p0}, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeAudioState;->popString16UTF8()Ljava/lang/String;

    move-result-object p1

    iput-object p1, p0, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeAudioState;->channel:Ljava/lang/String;

    .line 4
    invoke-virtual {p0}, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeAudioState;->popInt()I

    move-result p1

    iput p1, p0, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeAudioState;->uid:I
    ...
    iput p1, p0, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeAudioState;->oldstate:I
    ...
    iput p1, p0, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeAudioState;->newstate:I
    ...
    iput p1, p0, Lio/agora/rtc/internal/RtcEngineMessage$PSubscribeAudioState;->elapsed:I
