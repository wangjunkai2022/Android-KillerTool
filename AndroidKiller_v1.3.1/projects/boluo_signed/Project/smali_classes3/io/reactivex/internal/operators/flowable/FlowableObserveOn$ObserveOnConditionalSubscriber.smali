...
# instance fields
.field public final actual:Lf/a/e0/c/a;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lf/a/e0/c/a<",
            "-TT;>;"
...
# direct methods
.method public constructor <init>(Lf/a/e0/c/a;Lf/a/v$c;ZI)V
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-direct {p0, p2, p3, p4}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;-><init>(Lf/a/v$c;ZI)V

    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->actual:Lf/a/e0/c/a;
...
.method public onSubscribe(Ll/b/c;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->s:Ll/b/c;
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->s:Ll/b/c;
    ...
    check-cast v0, Lf/a/e0/c/h;

    const/4 v1, 0x7

    .line 5
    invoke-interface {v0, v1}, Lf/a/e0/c/g;->requestFusion(I)I
    ...
    .line 7
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lf/a/e0/c/k;

    .line 8
    iput-boolean v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->done:Z

    .line 9
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->actual:Lf/a/e0/c/a;

    invoke-interface {p1, p0}, Lf/a/g;->onSubscribe(Ll/b/c;)V
    ...
    .line 12
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->actual:Lf/a/e0/c/a;

    invoke-interface {v0, p0}, Lf/a/g;->onSubscribe(Ll/b/c;)V
...
.method public poll()Ljava/lang/Object;
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lf/a/e0/c/k;
    ...
    .line 6
    iget-object v3, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->s:Ll/b/c;

    invoke-interface {v3, v1, v2}, Ll/b/c;->request(J)V
...
.method public runAsync()V
    ...
    .line 2
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->queue:Lf/a/e0/c/k;
    ...
    .line 8
    :goto_2
    invoke-virtual {p0, v10, v12, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLl/b/b;)Z
    ...
    .line 9
    :cond_4
    invoke-interface {v0, v11}, Lf/a/e0/c/a;->a(Ljava/lang/Object;)Z
    ...
    .line 11
    iget-object v10, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->s:Ll/b/c;

    invoke-interface {v10, v4, v5}, Ll/b/c;->request(J)V
    ...
    invoke-interface {v3}, Ll/b/c;->cancel()V

    .line 14
    invoke-interface {v1}, Lf/a/e0/c/k;->clear()V

    .line 15
    invoke-interface {v0, v2}, Ll/b/b;->onError(Ljava/lang/Throwable;)V

    .line 16
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->worker:Lf/a/v$c;
    ...
    invoke-virtual {p0, v8, v9, v0}, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->checkTerminated(ZZLl/b/b;)Z
...
.method public runBackfused()V
    ...
    .line 3
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->actual:Lf/a/e0/c/a;

    const/4 v3, 0x0

    invoke-interface {v2, v3}, Ll/b/b;->onNext(Ljava/lang/Object;)V
    ...
    .line 5
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$ObserveOnConditionalSubscriber;->actual:Lf/a/e0/c/a;

    invoke-interface {v1, v0}, Ll/b/b;->onError(Ljava/lang/Throwable;)V
...
.method public runSync()V
    ...
    .line 9
    :cond_3
    invoke-interface {v0, v7}, Lf/a/e0/c/a;->a(Ljava/lang/Object;)Z
    ...
    .line 11
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableObserveOn$BaseObserveOnSubscriber;->s:Ll/b/c;

    invoke-interface {v2}, Ll/b/c;->cancel()V
