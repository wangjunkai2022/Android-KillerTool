...
.method public static cancel(Ljava/util/concurrent/atomic/AtomicReference;)Z
    ...
    .line 5
    invoke-interface {p0}, Ll/b/c;->cancel()V
...
.method public static deferredRequest(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;J)V
    ...
    .line 2
    invoke-interface {v0, p2, p3}, Ll/b/c;->request(J)V
    ...
    .line 4
    invoke-static {p1, p2, p3}, Lf/a/e0/i/b;->a(Ljava/util/concurrent/atomic/AtomicLong;J)J
    ...
    .line 7
    invoke-interface {p0, v0, v1}, Ll/b/c;->request(J)V
...
.method public static deferredSetOnce(Ljava/util/concurrent/atomic/AtomicReference;Ljava/util/concurrent/atomic/AtomicLong;Ll/b/c;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 1
    invoke-static {p0, p2}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Ll/b/c;)Z
    ...
    .line 3
    invoke-interface {p2, p0, p1}, Ll/b/c;->request(J)V
...
.method public static isCancelled(Ll/b/c;)Z
    .locals 1
...
.method public static replace(Ljava/util/concurrent/atomic/AtomicReference;Ll/b/c;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static set(Ljava/util/concurrent/atomic/AtomicReference;Ll/b/c;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Ll/b/c;)Z
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method public static setOnce(Ljava/util/concurrent/atomic/AtomicReference;Ll/b/c;J)Z
    .locals 0
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 6
    invoke-static {p0, p1}, Lio/reactivex/internal/subscriptions/SubscriptionHelper;->setOnce(Ljava/util/concurrent/atomic/AtomicReference;Ll/b/c;)Z
    ...
    .line 7
    invoke-interface {p1, p2, p3}, Ll/b/c;->request(J)V
...
.method public static validate(Ll/b/c;Ll/b/c;)Z
    .locals 1
    ...
    invoke-static {p0}, Lf/a/h0/a;->b(Ljava/lang/Throwable;)V
