...
.field public final onOverflow:Lf/a/d0/a;

.field public outputFused:Z

.field public final queue:Lf/a/e0/c/j;
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "Lf/a/e0/c/j<",
            "TT;>;"
...
.field public s:Ll/b/c;


# direct methods
.method public constructor <init>(Ll/b/b;IZZLf/a/d0/a;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 3
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->actual:Ll/b/b;

    .line 4
    iput-object p5, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->onOverflow:Lf/a/d0/a;
    ...
    .line 8
    :goto_0
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->queue:Lf/a/e0/c/j;
...
.method public cancel()V
    ...
    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->s:Ll/b/c;
    ...
    .line 5
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->queue:Lf/a/e0/c/j;
...
.method public checkTerminated(ZZLl/b/b;)Z
    .locals 2
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(ZZ",
    ...
    .line 2
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->queue:Lf/a/e0/c/j;
    ...
    .line 5
    invoke-interface {p3, p1}, Ll/b/b;->onError(Ljava/lang/Throwable;)V

    goto :goto_0

    .line 6
    :cond_1
    invoke-interface {p3}, Ll/b/b;->onComplete()V
    ...
    .line 8
    iget-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->queue:Lf/a/e0/c/j;
...
.method public drain()V
    ...
    .line 3
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->actual:Ll/b/b;
    ...
    invoke-virtual {p0, v4, v5, v1}, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->checkTerminated(ZZLl/b/b;)Z
    ...
    .line 7
    invoke-interface {v0}, Lf/a/e0/c/j;->poll()Ljava/lang/Object;
    ...
    .line 8
    :goto_1
    invoke-virtual {p0, v10, v12, v1}, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->checkTerminated(ZZLl/b/b;)Z
    ...
    .line 9
    :cond_4
    invoke-interface {v1, v11}, Ll/b/b;->onNext(Ljava/lang/Object;)V
    ...
    .line 12
    invoke-virtual {p0, v10, v11, v1}, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->checkTerminated(ZZLl/b/b;)Z
...
.method public onComplete()V
    ...
    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->actual:Ll/b/b;
...
.method public onNext(Ljava/lang/Object;)V
    ...
    .line 2
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->s:Ll/b/c;
    ...
    .line 4
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->onOverflow:Lf/a/d0/a;
    ...
    .line 9
    iget-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->actual:Ll/b/b;
...
.method public onSubscribe(Ll/b/c;)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->s:Ll/b/c;

    .line 3
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableOnBackpressureBuffer$BackpressureBufferSubscriber;->actual:Ll/b/b;

    invoke-interface {v0, p0}, Ll/b/b;->onSubscribe(Ll/b/c;)V
...
.method public request(J)V
    ...
    invoke-static {v0, p1, p2}, Lf/a/e0/i/b;->a(Ljava/util/concurrent/atomic/AtomicLong;J)J
